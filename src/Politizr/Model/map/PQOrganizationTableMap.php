...
class PQOrganizationTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('PUMandate', 'Politizr\\Model\\PUMandate', RelationMap::ONE_TO_MANY, array('id' => 'p_q_organization_id', ), 'CASCADE', 'CASCADE', 'PUMandates');
        $this->addRelation('PUAffinityQO', 'Politizr\\Model\\PUAffinityQO', RelationMap::ONE_TO_MANY, array('id' => 'p_q_organization_id', ), 'CASCADE', 'CASCADE', 'PUAffinityQos');
