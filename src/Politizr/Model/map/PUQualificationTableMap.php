...
/**
 * This class defines the structure of the 'p_u_qualification' table.
 *
 *
 *
 ...
 */
class PUQualificationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PUQualificationTableMap';
    ...
    {
        // attributes
        $this->setName('p_u_qualification');
        $this->setPhpName('PUQualification');
        $this->setClassname('Politizr\\Model\\PUQualification');
