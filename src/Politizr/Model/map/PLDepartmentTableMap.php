...
/**
 * This class defines the structure of the 'p_l_department' table.
 *
 *
 *
 ...
 */
class PLDepartmentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PLDepartmentTableMap';
    ...
    {
        // attributes
        $this->setName('p_l_department');
        $this->setPhpName('PLDepartment');
        $this->setClassname('Politizr\\Model\\PLDepartment');
