...
/**
 * This class defines the structure of the 'p_c_group_l_c' table.
 *
 *
 *
 ...
 */
class PCGroupLCTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PCGroupLCTableMap';
    ...
    {
        // attributes
        $this->setName('p_c_group_l_c');
        $this->setPhpName('PCGroupLC');
        $this->setClassname('Politizr\\Model\\PCGroupLC');
