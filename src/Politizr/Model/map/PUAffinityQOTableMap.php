...
/**
 * This class defines the structure of the 'p_u_affinity_q_o' table.
 *
 *
 *
 ...
 */
class PUAffinityQOTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PUAffinityQOTableMap';
    ...
    {
        // attributes
        $this->setName('p_u_affinity_q_o');
        $this->setPhpName('PUAffinityQO');
        $this->setClassname('Politizr\\Model\\PUAffinityQO');
