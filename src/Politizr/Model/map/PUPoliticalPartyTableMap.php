...
/**
 * This class defines the structure of the 'p_u_political_party' table.
 *
 *
 *
 ...
 */
class PUPoliticalPartyTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PUPoliticalPartyTableMap';
    ...
    {
        // attributes
        $this->setName('p_u_political_party');
        $this->setPhpName('PUPoliticalParty');
        $this->setClassname('Politizr\\Model\\PUPoliticalParty');
