...
/**
 * This class defines the structure of the 'p_m_user_historic' table.
 *
 *
 *
 ...
 */
class PMUserHistoricTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PMUserHistoricTableMap';
    ...
    {
        // attributes
        $this->setName('p_m_user_historic');
        $this->setPhpName('PMUserHistoric');
        $this->setClassname('Politizr\\Model\\PMUserHistoric');
