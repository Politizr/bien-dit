...
/**
 * This class defines the structure of the 'p_d_r_tagged_t' table.
 *
 *
 *
 ...
 */
class PDRTaggedTTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PDRTaggedTTableMap';
    ...
    {
        // attributes
        $this->setName('p_d_r_tagged_t');
        $this->setPhpName('PDRTaggedT');
        $this->setClassname('Politizr\\Model\\PDRTaggedT');
