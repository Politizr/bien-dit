...
/**
 * This class defines the structure of the 'p_u_in_p_c' table.
 *
 *
 *
 ...
 */
class PUInPCTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Politizr.Model.map.PUInPCTableMap';
    ...
    {
        // attributes
        $this->setName('p_u_in_p_c');
        $this->setPhpName('PUInPC');
        $this->setClassname('Politizr\\Model\\PUInPC');
        ...
        $this->addColumn('is_authorized_reaction', 'IsAuthorizedReaction', 'BOOLEAN', false, 1, false);
