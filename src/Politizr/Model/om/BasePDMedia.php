...
abstract class BasePDMedia extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDMediaPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDMediaPeer::ID;
        }
    ...
    public function setPDDebateId($v)
    {
        ...
        if ($this->p_d_debate_id !== $v) {
            ...
            $this->modifiedColumns[] = PDMediaPeer::P_D_DEBATE_ID;
        }
    ...
    public function setPDReactionId($v)
    {
        ...
        if ($this->p_d_reaction_id !== $v) {
            ...
            $this->modifiedColumns[] = PDMediaPeer::P_D_REACTION_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = PDMediaPeer::PATH;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PDMediaPeer::FILE_NAME;
        }
    ...
    public function setExtension($v)
    {
        ...
        if ($this->extension !== $v) {
            $this->extension = $v;
            $this->modifiedColumns[] = PDMediaPeer::EXTENSION;
        }
    ...
    public function setSize($v)
    {
        ...
        if ($this->size !== $v) {
            $this->size = $v;
            $this->modifiedColumns[] = PDMediaPeer::SIZE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDMediaPeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDMediaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PDMediaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PDMediaPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PDMediaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDMediaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDMediaPeer::P_D_DEBATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_debate_id`';
        }
        if ($this->isColumnModified(PDMediaPeer::P_D_REACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_reaction_id`';
        }
        if ($this->isColumnModified(PDMediaPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(PDMediaPeer::FILE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`file_name`';
        }
        if ($this->isColumnModified(PDMediaPeer::EXTENSION)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_d_media` (%s) VALUES (%s)',
    ...
    {
        $pos = PDMediaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDMedia'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDMedia'][$this->getPrimaryKey()] = true;
        $keys = PDMediaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDMediaPeer::ID)) $criteria->add(PDMediaPeer::ID, $this->id);
        if ($this->isColumnModified(PDMediaPeer::P_D_DEBATE_ID)) $criteria->add(PDMediaPeer::P_D_DEBATE_ID, $this->p_d_debate_id);
        if ($this->isColumnModified(PDMediaPeer::P_D_REACTION_ID)) $criteria->add(PDMediaPeer::P_D_REACTION_ID, $this->p_d_reaction_id);
        if ($this->isColumnModified(PDMediaPeer::PATH)) $criteria->add(PDMediaPeer::PATH, $this->path);
    ...
    {
        $criteria = new Criteria(PDMediaPeer::DATABASE_NAME);
        $criteria->add(PDMediaPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDMedia (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDMedia Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPDDebate(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDDebate === null && ($this->p_d_debate_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPDDebate->addPDMedias($this);
             */
        }
    ...
    public function getPDReaction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDReaction === null && ($this->p_d_reaction_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPDReaction->addPDMedias($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PDMediaPeer::DEFAULT_STRING_FORMAT);
    }
