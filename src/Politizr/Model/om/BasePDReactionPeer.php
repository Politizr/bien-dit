            ...
            if (!empty($keys)) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
                    ...
                    if (null !== ($object = PDReactionPeer::getInstanceFromPool($key))) {
                        ...
                        $object->setLeftValue($row[30]);
                        $object->setRightValue($row[31]);
                        $object->setLevel($row[32]);
