...
abstract class BasePUserArchive extends BaseObject implements Persistent
{
    ...
    public function setWithShadow($v)
    {
        ...
        if ($this->with_shadow !== $v) {
            $this->with_shadow = $v;
            $this->modifiedColumns[] = PUserArchivePeer::WITH_SHADOW;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->with_shadow = ($row[$startcol + 26] !== null) ? (boolean) $row[$startcol + 26] : null;
            ...
            $this->slug = ($row[$startcol + 46] !== null) ? (string) $row[$startcol + 46] : null;
            $this->archived_at = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
            $this->resetModified();
            ...
            return $startcol + 48; // 48 = PUserArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUserArchivePeer::WITH_SHADOW)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[46] => $this->getSlug(),
            $keys[47] => $this->getArchivedAt(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[26], $arr)) $this->setWithShadow($arr[$keys[26]]);
        ...
        if (array_key_exists($keys[46], $arr)) $this->setSlug($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setArchivedAt($arr[$keys[47]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUserArchivePeer::WITH_SHADOW)) $criteria->add(PUserArchivePeer::WITH_SHADOW, $this->with_shadow);
