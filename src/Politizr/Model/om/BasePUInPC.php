...
abstract class BasePUInPC extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUInPCPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUInPCPeer::ID;
        }
    ...
    public function setPCircleId($v)
    {
        ...
        if ($this->p_circle_id !== $v) {
            $this->p_circle_id = $v;
            $this->modifiedColumns[] = PUInPCPeer::P_CIRCLE_ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PUInPCPeer::P_USER_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUInPCPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUInPCPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUInPCPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PUInPCQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUInPCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUInPCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PUInPCPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUInPCPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUInPCPeer::P_CIRCLE_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_in_p_c` (%s) VALUES (%s)',
    ...
    {
        $pos = PUInPCPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUInPC'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUInPC'][$this->getPrimaryKey()] = true;
        $keys = PUInPCPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(PUInPCPeer::DATABASE_NAME);
        $criteria->add(PUInPCPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUInPC (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUInPC Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PUInPCPeer::DEFAULT_STRING_FORMAT);
    }
