...
abstract class BasePDDTaggedT extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDDTaggedTPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDDTaggedTPeer::ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDTaggedTPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDTaggedTPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating PDDTaggedT object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDDTaggedTPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PDDTaggedTQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // archivable behavior
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling PDDTaggedTQuery::delete().
                } else {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PDDTaggedTPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PDDTaggedTPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PDDTaggedTPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PDDTaggedTPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDDTaggedTPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDDTaggedTPeer::P_D_DEBATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_debate_id`';
        }
        if ($this->isColumnModified(PDDTaggedTPeer::P_TAG_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_d_d_tagged_t` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDDTaggedTPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDDTaggedTPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDDTaggedT'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDDTaggedT'][$this->getPrimaryKey()] = true;
        $keys = PDDTaggedTPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDDTaggedTPeer::ID)) $criteria->add(PDDTaggedTPeer::ID, $this->id);
        if ($this->isColumnModified(PDDTaggedTPeer::P_D_DEBATE_ID)) $criteria->add(PDDTaggedTPeer::P_D_DEBATE_ID, $this->p_d_debate_id);
        if ($this->isColumnModified(PDDTaggedTPeer::P_TAG_ID)) $criteria->add(PDDTaggedTPeer::P_TAG_ID, $this->p_tag_id);
        if ($this->isColumnModified(PDDTaggedTPeer::CREATED_AT)) $criteria->add(PDDTaggedTPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PDDTaggedTPeer::UPDATED_AT)) $criteria->add(PDDTaggedTPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PDDTaggedTPeer::DATABASE_NAME);
        $criteria->add(PDDTaggedTPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDDTaggedT (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDDTaggedT Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDDTaggedTPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDDTaggedTPeer();
        }
    ...
    {
        return (string) $this->exportTo(PDDTaggedTPeer::DEFAULT_STRING_FORMAT);
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return     PDDTaggedTArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(PropelPDO $con = null)
    {
        ...
        $archive = PDDTaggedTArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     PDDTaggedTArchive The archive object based on this object
     */
     ...
     *
     * @param      PDDTaggedTArchive $archive An archived object based on the same class
