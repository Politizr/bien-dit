...
abstract class BasePDDTaggedT extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PDDTaggedTPeer::NUM_HYDRATE_COLUMNS.
    ...
    {
        if (isset($alreadyDumpedObjects['PDDTaggedT'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDDTaggedT'][serialize($this->getPrimaryKey())] = true;
    ...
    {
        $criteria = new Criteria(PDDTaggedTPeer::DATABASE_NAME);
        $criteria->add(PDDTaggedTPeer::P_D_DEBATE_ID, $this->p_d_debate_id);
        $criteria->add(PDDTaggedTPeer::P_TAG_ID, $this->p_tag_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPDDebateId()) && (null === $this->getPTagId());
    }
