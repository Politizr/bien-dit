...
abstract class BasePQMandate extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PQMandatePeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PQMandatePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PQMandatePeer::TITLE;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PQMandatePeer::ONLINE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PQMandatePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PQMandatePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PQMandatePeer::SLUG;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = PQMandatePeer::SORTABLE_RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->p_q_type_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PQMandatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PQMandateQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // sortable behavior

            PQMandatePeer::shiftRank(-1, $this->getSortableRank() + 1, null, $this->getScopeValue(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isColumnModified(PQMandatePeer::SLUG) && $this->getSlug()) {
                $this->setSlug($this->makeSlugUnique($this->getSlug()));
            } elseif ($this->isColumnModified(PQMandatePeer::TITLE)) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PQMandatePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PQMandatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // sortable behavior
                if (!$this->isColumnModified(PQMandatePeer::RANK_COL)) {
                    $this->setSortableRank(PQMandateQuery::create()->getMaxRankArray($this->getScopeValue(), $con) + 1);
                }
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PQMandatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // sortable behavior
                ...
                if (($this->isColumnModified(PQMandatePeer::P_Q_TYPE_ID)) && !$this->isColumnModified(PQMandatePeer::RANK_COL)) { PQMandatePeer::shiftRank(-1, $this->getSortableRank() + 1, null, $this->oldScope, $con);
            ...
            if ($ret) {
                ...
                PQMandatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PQMandatePeer::SLUG)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PQMandatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PQMandatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PQMandate'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PQMandate'][$this->getPrimaryKey()] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setPQTypeId($arr[$keys[7]]);
    }
    ...
    {
        $criteria = new Criteria(PQMandatePeer::DATABASE_NAME);
        $criteria->add(PQMandatePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PQMandate (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PQMandate Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PQMandatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PQMandatePeer();
        }
    ...
    public function getPQType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPQType === null && ($this->p_q_type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPQType->addPQMandates($this);
             */
        }
     ...
     * If this PQMandate is new, it will return
    ...
    public function setPUMandates(PropelCollection $pUMandates, PropelPDO $con = null)
    {
        ...
        foreach ($pUMandatesToDelete as $pUMandateRemoved) {
            $pUMandateRemoved->setPQMandate(null);
        }
     ...
     * Otherwise if this PQMandate is new, it will return
     * an empty collection; or if this PQMandate has previously
     * been saved, it will retrieve related PUMandates from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PQMandate.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(PQMandatePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        return $this->getSortableRank() == PQMandateQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
    }
     ...
     * @param     PropelPDO  $con      optional connection
     *
     * @return    PQMandate the current object
     *
     * @throws    PropelException
     */
    public function insertAtRank($rank, PropelPDO $con = null)
    {
        $maxRank = PQMandateQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > PQMandateQuery::create()->getMaxRankArray($this->getScopeValue(), $con)) {
        ...
        try {
            ...
            PQMandatePeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $this->getScopeValue(), $con);
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = PQMandateQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
