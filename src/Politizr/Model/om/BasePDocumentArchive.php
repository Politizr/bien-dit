...
abstract class BasePDocumentArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDocumentArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PDocumentArchivePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::P_USER_ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::TITLE;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::FILE_NAME;
        }
    ...
    public function setSummary($v)
    {
        ...
        if ($this->summary !== $v) {
            $this->summary = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::SUMMARY;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::DESCRIPTION;
        }
    ...
    public function setNotePos($v)
    {
        ...
        if ($this->note_pos !== $v) {
            $this->note_pos = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::NOTE_POS;
        }
    ...
    public function setNoteNeg($v)
    {
        ...
        if ($this->note_neg !== $v) {
            $this->note_neg = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::NOTE_NEG;
        }
    ...
    public function setNbViews($v)
    {
        ...
        if ($this->nb_views !== $v) {
            $this->nb_views = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::NB_VIEWS;
        }
    ...
    public function setPublished($v)
    {
        ...
        if ($this->published !== $v) {
            $this->published = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::PUBLISHED;
        }
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->published_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDocumentArchivePeer::PUBLISHED_AT;
            }
    ...
    public function setPublishedBy($v)
    {
        ...
        if ($this->published_by !== $v) {
            $this->published_by = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::PUBLISHED_BY;
        }
    ...
    public function setFavorite($v)
    {
        ...
        if ($this->favorite !== $v) {
            $this->favorite = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::FAVORITE;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PDocumentArchivePeer::ONLINE;
        }
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDocumentArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDocumentArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PDocumentArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                PDocumentArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDocumentArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::TITLE)) {
        ...
        if ($this->isColumnModified(PDocumentArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::NOTE_POS)) {
            $modifiedColumns[':p' . $index++]  = '`note_pos`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::NOTE_NEG)) {
            $modifiedColumns[':p' . $index++]  = '`note_neg`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::NB_VIEWS)) {
            $modifiedColumns[':p' . $index++]  = '`nb_views`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::PUBLISHED)) {
            $modifiedColumns[':p' . $index++]  = '`published`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::PUBLISHED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`published_at`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::PUBLISHED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`published_by`';
        }
        if ($this->isColumnModified(PDocumentArchivePeer::FAVORITE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_document_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDocumentArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDocumentArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDocumentArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDocumentArchive'][$this->getPrimaryKey()] = true;
        $keys = PDocumentArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDocumentArchivePeer::ID)) $criteria->add(PDocumentArchivePeer::ID, $this->id);
        ...
        if ($this->isColumnModified(PDocumentArchivePeer::NOTE_NEG)) $criteria->add(PDocumentArchivePeer::NOTE_NEG, $this->note_neg);
        if ($this->isColumnModified(PDocumentArchivePeer::NB_VIEWS)) $criteria->add(PDocumentArchivePeer::NB_VIEWS, $this->nb_views);
        if ($this->isColumnModified(PDocumentArchivePeer::PUBLISHED)) $criteria->add(PDocumentArchivePeer::PUBLISHED, $this->published);
        ...
        if ($this->isColumnModified(PDocumentArchivePeer::FAVORITE)) $criteria->add(PDocumentArchivePeer::FAVORITE, $this->favorite);
    ...
    {
        $criteria = new Criteria(PDocumentArchivePeer::DATABASE_NAME);
        $criteria->add(PDocumentArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDocumentArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDocumentArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDocumentArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDocumentArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PDocumentArchivePeer::DEFAULT_STRING_FORMAT);
    }
