...
abstract class BasePDReaction extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->with_shadow = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
            ...
            return $startcol + 23; // 23 = PDReactionPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setWithShadow($arr[$keys[7]]);
