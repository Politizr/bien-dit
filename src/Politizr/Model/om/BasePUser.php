...
abstract class BasePUser extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->biography = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->website = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->twitter = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->facebook = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->email = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->phone = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->last_connect = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            ...
            return $startcol + 19; // 19 = PUserPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[8] => $this->getBiography(),
            $keys[9] => $this->getWebsite(),
            $keys[10] => $this->getTwitter(),
            $keys[11] => $this->getFacebook(),
            $keys[12] => $this->getEmail(),
            $keys[13] => $this->getPhone(),
            $keys[14] => $this->getLastConnect(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setBiography($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setWebsite($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setTwitter($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setFacebook($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setEmail($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setPhone($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setLastConnect($arr[$keys[14]]);
