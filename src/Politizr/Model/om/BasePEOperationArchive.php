...
abstract class BasePEOperationArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PEOperationArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PEOperationArchivePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::UUID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::P_USER_ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::DESCRIPTION;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::FILE_NAME;
        }
    ...
    public function setGeoScoped($v)
    {
        ...
        if ($this->geo_scoped !== $v) {
            $this->geo_scoped = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::GEO_SCOPED;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::ONLINE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PEOperationArchivePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PEOperationArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PEOperationArchivePeer::SLUG;
        }
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PEOperationArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = PEOperationArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PEOperationArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PEOperationArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PEOperationArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PEOperationArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::TITLE)) {
        ...
        if ($this->isColumnModified(PEOperationArchivePeer::GEO_SCOPED)) {
            $modifiedColumns[':p' . $index++]  = '`geo_scoped`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::ONLINE)) {
            $modifiedColumns[':p' . $index++]  = '`online`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }
        if ($this->isColumnModified(PEOperationArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_e_operation_archive` (%s) VALUES (%s)',
    ...
    {
        $pos = PEOperationArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PEOperationArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PEOperationArchive'][$this->getPrimaryKey()] = true;
        $keys = PEOperationArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUuid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PEOperationArchivePeer::ID)) $criteria->add(PEOperationArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PEOperationArchivePeer::UUID)) $criteria->add(PEOperationArchivePeer::UUID, $this->uuid);
        ...
        if ($this->isColumnModified(PEOperationArchivePeer::ARCHIVED_AT)) $criteria->add(PEOperationArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PEOperationArchivePeer::DATABASE_NAME);
        $criteria->add(PEOperationArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PEOperationArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PEOperationArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PEOperationArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PEOperationArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PEOperationArchivePeer::DEFAULT_STRING_FORMAT);
    }
