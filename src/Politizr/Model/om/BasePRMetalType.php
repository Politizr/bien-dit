...
abstract class BasePRMetalType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PRMetalTypePeer';
     ...
     * @return PRMetalType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PRMetalTypePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PRMetalTypePeer::TITLE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PRMetalTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PRMetalTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PRMetalTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PRMetalType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PRMetalTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PRMetalTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PRMetalTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PRMetalTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PRMetalTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PRMetalTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PRMetalTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PRMetalTypePeer::TITLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_r_metal_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PRMetalTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PRMetalTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PRMetalType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PRMetalType'][$this->getPrimaryKey()] = true;
        $keys = PRMetalTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PRMetalTypePeer::ID)) $criteria->add(PRMetalTypePeer::ID, $this->id);
        if ($this->isColumnModified(PRMetalTypePeer::TITLE)) $criteria->add(PRMetalTypePeer::TITLE, $this->title);
        if ($this->isColumnModified(PRMetalTypePeer::CREATED_AT)) $criteria->add(PRMetalTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PRMetalTypePeer::UPDATED_AT)) $criteria->add(PRMetalTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PRMetalTypePeer::DATABASE_NAME);
        $criteria->add(PRMetalTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PRMetalType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PRMetalType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PRMetalTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PRMetalTypePeer();
        }
     ...
     * If this PRMetalType is new, it will return
    ...
    public function setPRBadges(PropelCollection $pRBadges, PropelPDO $con = null)
    {
        ...
        foreach ($pRBadgesToDelete as $pRBadgeRemoved) {
            $pRBadgeRemoved->setPRMetalType(null);
        }
     ...
     * Otherwise if this PRMetalType is new, it will return
     * an empty collection; or if this PRMetalType has previously
     * been saved, it will retrieve related PRBadges from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PRMetalType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|PRBadge[] List of PRBadge objects
     */
    public function getPRBadgesJoinPRBadgeFamily($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PRBadgeQuery::create(null, $criteria);
        $query->joinWith('PRBadgeFamily', $join_behavior);
    ...
    {
        return (string) $this->exportTo(PRMetalTypePeer::DEFAULT_STRING_FORMAT);
    }
