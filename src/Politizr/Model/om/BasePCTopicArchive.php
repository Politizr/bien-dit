...
abstract class BasePCTopicArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PCTopicArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PCTopicArchivePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::UUID;
        }
    ...
    public function setPCircleId($v)
    {
        ...
        if ($this->p_circle_id !== $v) {
            $this->p_circle_id = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::P_CIRCLE_ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::TITLE;
        }
    ...
    public function setSummary($v)
    {
        ...
        if ($this->summary !== $v) {
            $this->summary = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::SUMMARY;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::DESCRIPTION;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::ONLINE;
        }
    ...
    public function setForceGeolocType($v)
    {
        ...
        if ($this->force_geoloc_type !== $v) {
            ...
            $this->modifiedColumns[] = PCTopicArchivePeer::FORCE_GEOLOC_TYPE;
        }
    ...
    public function setForceGeolocId($v)
    {
        ...
        if ($this->force_geoloc_id !== $v) {
            ...
            $this->modifiedColumns[] = PCTopicArchivePeer::FORCE_GEOLOC_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCTopicArchivePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCTopicArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PCTopicArchivePeer::SLUG;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = PCTopicArchivePeer::SORTABLE_RANK;
        }
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCTopicArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 15; // 15 = PCTopicArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PCTopicArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PCTopicArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PCTopicArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PCTopicArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::P_CIRCLE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_circle_id`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::SUMMARY)) {
        ...
        if ($this->isColumnModified(PCTopicArchivePeer::FORCE_GEOLOC_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`force_geoloc_type`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::FORCE_GEOLOC_ID)) {
            $modifiedColumns[':p' . $index++]  = '`force_geoloc_id`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::SORTABLE_RANK)) {
            $modifiedColumns[':p' . $index++]  = '`sortable_rank`';
        }
        if ($this->isColumnModified(PCTopicArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_c_topic_archive` (%s) VALUES (%s)',
    ...
    {
        $pos = PCTopicArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PCTopicArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PCTopicArchive'][$this->getPrimaryKey()] = true;
        $keys = PCTopicArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUuid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PCTopicArchivePeer::ID)) $criteria->add(PCTopicArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PCTopicArchivePeer::UUID)) $criteria->add(PCTopicArchivePeer::UUID, $this->uuid);
        if ($this->isColumnModified(PCTopicArchivePeer::P_CIRCLE_ID)) $criteria->add(PCTopicArchivePeer::P_CIRCLE_ID, $this->p_circle_id);
        ...
        if ($this->isColumnModified(PCTopicArchivePeer::CREATED_AT)) $criteria->add(PCTopicArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PCTopicArchivePeer::UPDATED_AT)) $criteria->add(PCTopicArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PCTopicArchivePeer::SLUG)) $criteria->add(PCTopicArchivePeer::SLUG, $this->slug);
        if ($this->isColumnModified(PCTopicArchivePeer::SORTABLE_RANK)) $criteria->add(PCTopicArchivePeer::SORTABLE_RANK, $this->sortable_rank);
        if ($this->isColumnModified(PCTopicArchivePeer::ARCHIVED_AT)) $criteria->add(PCTopicArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PCTopicArchivePeer::DATABASE_NAME);
        $criteria->add(PCTopicArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PCTopicArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PCTopicArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PCTopicArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PCTopicArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PCTopicArchivePeer::DEFAULT_STRING_FORMAT);
    }
