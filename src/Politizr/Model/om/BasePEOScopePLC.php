...
abstract class BasePEOScopePLC extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PEOScopePLCPeer';
     ...
     * @return PEOScopePLC The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PEOScopePLCPeer::ID;
        }
    ...
    public function setPEOperationId($v)
    {
        ...
        if ($this->p_e_operation_id !== $v) {
            ...
            $this->modifiedColumns[] = PEOScopePLCPeer::P_E_OPERATION_ID;
        }
    ...
    public function setPLCityId($v)
    {
        ...
        if ($this->p_l_city_id !== $v) {
            $this->p_l_city_id = $v;
            $this->modifiedColumns[] = PEOScopePLCPeer::P_L_CITY_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PEOScopePLCPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PEOScopePLCPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PEOScopePLCPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PEOScopePLC object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PEOScopePLCPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PEOScopePLCQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PEOScopePLCPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PEOScopePLCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PEOScopePLCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PEOScopePLCPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PEOScopePLCPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PEOScopePLCPeer::P_E_OPERATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_e_operation_id`';
        }
        if ($this->isColumnModified(PEOScopePLCPeer::P_L_CITY_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_e_o_scope_p_l_c` (%s) VALUES (%s)',
    ...
    {
        $pos = PEOScopePLCPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PEOScopePLC'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PEOScopePLC'][$this->getPrimaryKey()] = true;
        $keys = PEOScopePLCPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PEOScopePLCPeer::ID)) $criteria->add(PEOScopePLCPeer::ID, $this->id);
        if ($this->isColumnModified(PEOScopePLCPeer::P_E_OPERATION_ID)) $criteria->add(PEOScopePLCPeer::P_E_OPERATION_ID, $this->p_e_operation_id);
        if ($this->isColumnModified(PEOScopePLCPeer::P_L_CITY_ID)) $criteria->add(PEOScopePLCPeer::P_L_CITY_ID, $this->p_l_city_id);
        if ($this->isColumnModified(PEOScopePLCPeer::CREATED_AT)) $criteria->add(PEOScopePLCPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PEOScopePLCPeer::UPDATED_AT)) $criteria->add(PEOScopePLCPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PEOScopePLCPeer::DATABASE_NAME);
        $criteria->add(PEOScopePLCPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PEOScopePLC (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PEOScopePLC Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PEOScopePLCPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PEOScopePLCPeer();
        }
    ...
    public function getPEOperation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPEOperation === null && ($this->p_e_operation_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPEOperation->addPEOScopePLCs($this);
             */
        }
    ...
    public function getPLCity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPLCity === null && ($this->p_l_city_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPLCity->addPEOScopePLCs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PEOScopePLCPeer::DEFAULT_STRING_FORMAT);
    }
