...
abstract class BasePRBadgeArchivePeer
{
    ...
    const TM_CLASS = 'PRBadgeArchiveTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of PRBadgeArchive objects.
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePRBadgeArchivePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PRBadgeArchiveTableMap());
      }
    }
