...
abstract class BasePLCountry extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PLCountryPeer';
     ...
     * @return PLCountry The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PLCountryPeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PLCountryPeer::TITLE;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PLCountryPeer::UUID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PLCountryPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PLCountryPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PLCountryPeer::SLUG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = PLCountryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PLCountry object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PLCountryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PLCountryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isColumnModified(PLCountryPeer::SLUG) && $this->getSlug()) {
                $this->setSlug($this->makeSlugUnique($this->getSlug()));
            } elseif ($this->isColumnModified(PLCountryPeer::TITLE)) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PLCountryPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PLCountryPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PLCountryPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PLCountryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PLCountryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PLCountryPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PLCountryPeer::UUID)) {
        ...
        if ($this->isColumnModified(PLCountryPeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }

        $sql = sprintf(
            'INSERT INTO `p_l_country` (%s) VALUES (%s)',
    ...
    {
        $pos = PLCountryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PLCountry'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PLCountry'][$this->getPrimaryKey()] = true;
        $keys = PLCountryPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PLCountryPeer::ID)) $criteria->add(PLCountryPeer::ID, $this->id);
        if ($this->isColumnModified(PLCountryPeer::TITLE)) $criteria->add(PLCountryPeer::TITLE, $this->title);
        if ($this->isColumnModified(PLCountryPeer::UUID)) $criteria->add(PLCountryPeer::UUID, $this->uuid);
        if ($this->isColumnModified(PLCountryPeer::CREATED_AT)) $criteria->add(PLCountryPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PLCountryPeer::UPDATED_AT)) $criteria->add(PLCountryPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PLCountryPeer::SLUG)) $criteria->add(PLCountryPeer::SLUG, $this->slug);
    ...
    {
        $criteria = new Criteria(PLCountryPeer::DATABASE_NAME);
        $criteria->add(PLCountryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PLCountry (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PLCountry Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PLCountryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PLCountryPeer();
        }
     ...
     * If this PLCountry is new, it will return
    ...
    public function setPDDebates(PropelCollection $pDDebates, PropelPDO $con = null)
    {
        ...
        foreach ($pDDebatesToDelete as $pDDebateRemoved) {
            $pDDebateRemoved->setPLCountry(null);
        }
     ...
     * Otherwise if this PLCountry is new, it will return
     * an empty collection; or if this PLCountry has previously
     * been saved, it will retrieve related PDDebates from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PLCountry.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setPDReactions(PropelCollection $pDReactions, PropelPDO $con = null)
    {
        ...
        foreach ($pDReactionsToDelete as $pDReactionRemoved) {
            $pDReactionRemoved->setPLCountry(null);
        }
    ...
    public function setPLRegions(PropelCollection $pLRegions, PropelPDO $con = null)
    {
        ...
        foreach ($pLRegionsToDelete as $pLRegionRemoved) {
            $pLRegionRemoved->setPLCountry(null);
        }
    ...
    {
        return (string) $this->exportTo(PLCountryPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    * Create UUID if is NULL Uuid*/
    ...
    /**
    * If permanent UUID, throw exception p_l_country.uuid*/
