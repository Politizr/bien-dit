...
abstract class BasePDDCommentArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDDCommentArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PDDCommentArchivePeer
     */
    ...
    /**
     * Initializes internal state of BasePDDCommentArchive object.
     * @see        applyDefaults()
     */
     ...
     * @return PDDCommentArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::UUID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::P_USER_ID;
        }
    ...
    public function setPDDebateId($v)
    {
        ...
        if ($this->p_d_debate_id !== $v) {
            ...
            $this->modifiedColumns[] = PDDCommentArchivePeer::P_D_DEBATE_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::DESCRIPTION;
        }
    ...
    public function setParagraphNo($v)
    {
        ...
        if ($this->paragraph_no !== $v) {
            $this->paragraph_no = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::PARAGRAPH_NO;
        }
    ...
    public function setNotePos($v)
    {
        ...
        if ($this->note_pos !== $v) {
            $this->note_pos = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::NOTE_POS;
        }
    ...
    public function setNoteNeg($v)
    {
        ...
        if ($this->note_neg !== $v) {
            $this->note_neg = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::NOTE_NEG;
        }
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->published_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDCommentArchivePeer::PUBLISHED_AT;
            }
    ...
    public function setPublishedBy($v)
    {
        ...
        if ($this->published_by !== $v) {
            $this->published_by = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::PUBLISHED_BY;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::ONLINE;
        }
    ...
    public function setModerated($v)
    {
        ...
        if ($this->moderated !== $v) {
            $this->moderated = $v;
            $this->modifiedColumns[] = PDDCommentArchivePeer::MODERATED;
        }
    ...
    public function setModeratedPartial($v)
    {
        ...
        if ($this->moderated_partial !== $v) {
            ...
            $this->modifiedColumns[] = PDDCommentArchivePeer::MODERATED_PARTIAL;
        }
    ...
    public function setModeratedAt($v)
    {
        ...
        if ($this->moderated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDCommentArchivePeer::MODERATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDCommentArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDCommentArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDDCommentArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 17; // 17 = PDDCommentArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PDDCommentArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDDCommentArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PDDCommentArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PDDCommentArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDDCommentArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::P_D_DEBATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_debate_id`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::PARAGRAPH_NO)) {
            $modifiedColumns[':p' . $index++]  = '`paragraph_no`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::NOTE_POS)) {
            $modifiedColumns[':p' . $index++]  = '`note_pos`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::NOTE_NEG)) {
            $modifiedColumns[':p' . $index++]  = '`note_neg`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::PUBLISHED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`published_at`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::PUBLISHED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`published_by`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::ONLINE)) {
            $modifiedColumns[':p' . $index++]  = '`online`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED)) {
            $modifiedColumns[':p' . $index++]  = '`moderated`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED_PARTIAL)) {
            $modifiedColumns[':p' . $index++]  = '`moderated_partial`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`moderated_at`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PDDCommentArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_d_d_comment_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDDCommentArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDDCommentArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDDCommentArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDDCommentArchive'][$this->getPrimaryKey()] = true;
        $keys = PDDCommentArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUuid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDDCommentArchivePeer::ID)) $criteria->add(PDDCommentArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PDDCommentArchivePeer::UUID)) $criteria->add(PDDCommentArchivePeer::UUID, $this->uuid);
        if ($this->isColumnModified(PDDCommentArchivePeer::P_USER_ID)) $criteria->add(PDDCommentArchivePeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PDDCommentArchivePeer::P_D_DEBATE_ID)) $criteria->add(PDDCommentArchivePeer::P_D_DEBATE_ID, $this->p_d_debate_id);
        if ($this->isColumnModified(PDDCommentArchivePeer::DESCRIPTION)) $criteria->add(PDDCommentArchivePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PDDCommentArchivePeer::PARAGRAPH_NO)) $criteria->add(PDDCommentArchivePeer::PARAGRAPH_NO, $this->paragraph_no);
        if ($this->isColumnModified(PDDCommentArchivePeer::NOTE_POS)) $criteria->add(PDDCommentArchivePeer::NOTE_POS, $this->note_pos);
        if ($this->isColumnModified(PDDCommentArchivePeer::NOTE_NEG)) $criteria->add(PDDCommentArchivePeer::NOTE_NEG, $this->note_neg);
        if ($this->isColumnModified(PDDCommentArchivePeer::PUBLISHED_AT)) $criteria->add(PDDCommentArchivePeer::PUBLISHED_AT, $this->published_at);
        if ($this->isColumnModified(PDDCommentArchivePeer::PUBLISHED_BY)) $criteria->add(PDDCommentArchivePeer::PUBLISHED_BY, $this->published_by);
        if ($this->isColumnModified(PDDCommentArchivePeer::ONLINE)) $criteria->add(PDDCommentArchivePeer::ONLINE, $this->online);
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED)) $criteria->add(PDDCommentArchivePeer::MODERATED, $this->moderated);
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED_PARTIAL)) $criteria->add(PDDCommentArchivePeer::MODERATED_PARTIAL, $this->moderated_partial);
        if ($this->isColumnModified(PDDCommentArchivePeer::MODERATED_AT)) $criteria->add(PDDCommentArchivePeer::MODERATED_AT, $this->moderated_at);
        if ($this->isColumnModified(PDDCommentArchivePeer::CREATED_AT)) $criteria->add(PDDCommentArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PDDCommentArchivePeer::UPDATED_AT)) $criteria->add(PDDCommentArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PDDCommentArchivePeer::ARCHIVED_AT)) $criteria->add(PDDCommentArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PDDCommentArchivePeer::DATABASE_NAME);
        $criteria->add(PDDCommentArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDDCommentArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDDCommentArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDDCommentArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDDCommentArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PDDCommentArchivePeer::DEFAULT_STRING_FORMAT);
    }
