...
abstract class BasePTagQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Politizr\\Model\\PTag', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `p_t_tag_type_id`, `title`, `online`, `created_at`, `updated_at`, `slug` FROM `p_tag` WHERE `id` = :p0';
        try {
     ...
     *
     * @return    PTag the result, formatted by the current formatter
     */
