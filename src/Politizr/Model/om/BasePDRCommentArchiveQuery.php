 ...
 * @method PDRCommentArchiveQuery orderByParagraphNo($order = Criteria::ASC) Order by the paragraph_no column
 * @method PDRCommentArchiveQuery orderByNotePos($order = Criteria::ASC) Order by the note_pos column
 * @method PDRCommentArchiveQuery orderByNoteNeg($order = Criteria::ASC) Order by the note_neg column
 ...
 * @method PDRCommentArchiveQuery groupByParagraphNo() Group by the paragraph_no column
 * @method PDRCommentArchiveQuery groupByNotePos() Group by the note_pos column
 * @method PDRCommentArchiveQuery groupByNoteNeg() Group by the note_neg column
 ...
 *
 * @method PDRCommentArchiveQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method PDRCommentArchiveQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method PDRCommentArchiveQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 ...
 * @method PDRCommentArchive findOneByParagraphNo(int $paragraph_no) Return the first PDRCommentArchive filtered by the paragraph_no column
 * @method PDRCommentArchive findOneByNotePos(int $note_pos) Return the first PDRCommentArchive filtered by the note_pos column
 * @method PDRCommentArchive findOneByNoteNeg(int $note_neg) Return the first PDRCommentArchive filtered by the note_neg column
 ...
 * @method array findByParagraphNo(int $paragraph_no) Return PDRCommentArchive objects filtered by the paragraph_no column
 * @method array findByNotePos(int $note_pos) Return PDRCommentArchive objects filtered by the note_pos column
 * @method array findByNoteNeg(int $note_neg) Return PDRCommentArchive objects filtered by the note_neg column
 ...
 */
abstract class BasePDRCommentArchiveQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BasePDRCommentArchiveQuery object.
     *
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Politizr\\Model\\PDRCommentArchive';
        }
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new PDRCommentArchiveQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param   PDRCommentArchiveQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return PDRCommentArchiveQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PDRCommentArchiveQuery) {
            return $criteria;
        }
        $query = new PDRCommentArchiveQuery(null, null, $modelAlias);
     ...
     *
     * @return   PDRCommentArchive|PDRCommentArchive[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PDRCommentArchivePeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 PDRCommentArchive A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new PDRCommentArchive();
            $obj->hydrate($row);
            PDRCommentArchivePeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PDRCommentArchive[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByPUserId($pUserId = null, $comparison = null)
    {
        if (is_array($pUserId)) {
            ...
            if (isset($pUserId['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::P_USER_ID, $pUserId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($pUserId['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::P_USER_ID, $pUserId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::P_USER_ID, $pUserId, $comparison);
    }
    ...
    public function filterByPDReactionId($pDReactionId = null, $comparison = null)
    {
        if (is_array($pDReactionId)) {
            ...
            if (isset($pDReactionId['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::P_D_REACTION_ID, $pDReactionId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($pDReactionId['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::P_D_REACTION_ID, $pDReactionId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::P_D_REACTION_ID, $pDReactionId, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByParagraphNo($paragraphNo = null, $comparison = null)
    {
        if (is_array($paragraphNo)) {
            ...
            if (isset($paragraphNo['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::PARAGRAPH_NO, $paragraphNo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($paragraphNo['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::PARAGRAPH_NO, $paragraphNo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::PARAGRAPH_NO, $paragraphNo, $comparison);
    }
    ...
    public function filterByNotePos($notePos = null, $comparison = null)
    {
        if (is_array($notePos)) {
            ...
            if (isset($notePos['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::NOTE_POS, $notePos['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($notePos['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::NOTE_POS, $notePos['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::NOTE_POS, $notePos, $comparison);
    }
    ...
    public function filterByNoteNeg($noteNeg = null, $comparison = null)
    {
        if (is_array($noteNeg)) {
            ...
            if (isset($noteNeg['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::NOTE_NEG, $noteNeg['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($noteNeg['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::NOTE_NEG, $noteNeg['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::NOTE_NEG, $noteNeg, $comparison);
    }
    ...
    public function filterByPublishedAt($publishedAt = null, $comparison = null)
    {
        if (is_array($publishedAt)) {
            ...
            if (isset($publishedAt['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::PUBLISHED_AT, $publishedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishedAt['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::PUBLISHED_AT, $publishedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::PUBLISHED_AT, $publishedAt, $comparison);
    }
    ...
    public function filterByPublishedBy($publishedBy = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::PUBLISHED_BY, $publishedBy, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByArchivedAt($archivedAt = null, $comparison = null)
    {
        if (is_array($archivedAt)) {
            ...
            if (isset($archivedAt['min'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::ARCHIVED_AT, $archivedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($archivedAt['max'])) {
                $this->addUsingAlias(PDRCommentArchivePeer::ARCHIVED_AT, $archivedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PDRCommentArchivePeer::ARCHIVED_AT, $archivedAt, $comparison);
    }

    /**
     * Exclude object from result
     *
     * @param   PDRCommentArchive $pDRCommentArchive Object to remove from the list of results
     *
     * @return PDRCommentArchiveQuery The current query, for fluid interface
     */
    public function prune($pDRCommentArchive = null)
    {
        if ($pDRCommentArchive) {
            $this->addUsingAlias(PDRCommentArchivePeer::ID, $pDRCommentArchive->getId(), Criteria::NOT_EQUAL);
        }
