...
abstract class BasePDCommentArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDCommentArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PDCommentArchivePeer
     */
    ...
    /**
     * Initializes internal state of BasePDCommentArchive object.
     * @see        applyDefaults()
     */
     ...
     * @return PDCommentArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::P_USER_ID;
        }
    ...
    public function setPDocumentId($v)
    {
        ...
        if ($this->p_document_id !== $v) {
            ...
            $this->modifiedColumns[] = PDCommentArchivePeer::P_DOCUMENT_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::DESCRIPTION;
        }
    ...
    public function setParagraphNo($v)
    {
        ...
        if ($this->paragraph_no !== $v) {
            $this->paragraph_no = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::PARAGRAPH_NO;
        }
    ...
    public function setNotePos($v)
    {
        ...
        if ($this->note_pos !== $v) {
            $this->note_pos = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::NOTE_POS;
        }
    ...
    public function setNoteNeg($v)
    {
        ...
        if ($this->note_neg !== $v) {
            $this->note_neg = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::NOTE_NEG;
        }
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->published_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentArchivePeer::PUBLISHED_AT;
            }
    ...
    public function setPublishedBy($v)
    {
        ...
        if ($this->published_by !== $v) {
            $this->published_by = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::PUBLISHED_BY;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PDCommentArchivePeer::ONLINE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = PDCommentArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PDCommentArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDCommentArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PDCommentArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PDCommentArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDCommentArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::P_DOCUMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_document_id`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::PARAGRAPH_NO)) {
            $modifiedColumns[':p' . $index++]  = '`paragraph_no`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::NOTE_POS)) {
            $modifiedColumns[':p' . $index++]  = '`note_pos`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::NOTE_NEG)) {
            $modifiedColumns[':p' . $index++]  = '`note_neg`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::PUBLISHED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`published_at`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::PUBLISHED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`published_by`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::ONLINE)) {
            $modifiedColumns[':p' . $index++]  = '`online`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PDCommentArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_d_comment_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDCommentArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDCommentArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDCommentArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDCommentArchive'][$this->getPrimaryKey()] = true;
        $keys = PDCommentArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDCommentArchivePeer::ID)) $criteria->add(PDCommentArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PDCommentArchivePeer::P_USER_ID)) $criteria->add(PDCommentArchivePeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PDCommentArchivePeer::P_DOCUMENT_ID)) $criteria->add(PDCommentArchivePeer::P_DOCUMENT_ID, $this->p_document_id);
        if ($this->isColumnModified(PDCommentArchivePeer::DESCRIPTION)) $criteria->add(PDCommentArchivePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PDCommentArchivePeer::PARAGRAPH_NO)) $criteria->add(PDCommentArchivePeer::PARAGRAPH_NO, $this->paragraph_no);
        if ($this->isColumnModified(PDCommentArchivePeer::NOTE_POS)) $criteria->add(PDCommentArchivePeer::NOTE_POS, $this->note_pos);
        if ($this->isColumnModified(PDCommentArchivePeer::NOTE_NEG)) $criteria->add(PDCommentArchivePeer::NOTE_NEG, $this->note_neg);
        if ($this->isColumnModified(PDCommentArchivePeer::PUBLISHED_AT)) $criteria->add(PDCommentArchivePeer::PUBLISHED_AT, $this->published_at);
        if ($this->isColumnModified(PDCommentArchivePeer::PUBLISHED_BY)) $criteria->add(PDCommentArchivePeer::PUBLISHED_BY, $this->published_by);
        if ($this->isColumnModified(PDCommentArchivePeer::ONLINE)) $criteria->add(PDCommentArchivePeer::ONLINE, $this->online);
        if ($this->isColumnModified(PDCommentArchivePeer::CREATED_AT)) $criteria->add(PDCommentArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PDCommentArchivePeer::UPDATED_AT)) $criteria->add(PDCommentArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PDCommentArchivePeer::ARCHIVED_AT)) $criteria->add(PDCommentArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PDCommentArchivePeer::DATABASE_NAME);
        $criteria->add(PDCommentArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDCommentArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDCommentArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDCommentArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDCommentArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PDCommentArchivePeer::DEFAULT_STRING_FORMAT);
    }
