...
abstract class BasePUQualificationArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUQualificationArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PUQualificationArchivePeer
     */
     ...
     * @return PUQualificationArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUQualificationArchivePeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PUQualificationArchivePeer::P_USER_ID;
        }
    ...
    public function setPUPoliticalPartyId($v)
    {
        ...
        if ($this->p_u_political_party_id !== $v) {
            ...
            $this->modifiedColumns[] = PUQualificationArchivePeer::P_U_POLITICAL_PARTY_ID;
        }
    ...
    public function setPUMandateTypeId($v)
    {
        ...
        if ($this->p_u_mandate_type_id !== $v) {
            ...
            $this->modifiedColumns[] = PUQualificationArchivePeer::P_U_MANDATE_TYPE_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PUQualificationArchivePeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUQualificationArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUQualificationArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUQualificationArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = PUQualificationArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PUQualificationArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUQualificationArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PUQualificationArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PUQualificationArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUQualificationArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::P_U_POLITICAL_PARTY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_u_political_party_id`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::P_U_MANDATE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_u_mandate_type_id`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::BEGIN_AT)) {
            $modifiedColumns[':p' . $index++]  = '`begin_at`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::END_AT)) {
            $modifiedColumns[':p' . $index++]  = '`end_at`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PUQualificationArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_u_qualification_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PUQualificationArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PUQualificationArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUQualificationArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUQualificationArchive'][$this->getPrimaryKey()] = true;
        $keys = PUQualificationArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUQualificationArchivePeer::ID)) $criteria->add(PUQualificationArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PUQualificationArchivePeer::P_USER_ID)) $criteria->add(PUQualificationArchivePeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PUQualificationArchivePeer::P_U_POLITICAL_PARTY_ID)) $criteria->add(PUQualificationArchivePeer::P_U_POLITICAL_PARTY_ID, $this->p_u_political_party_id);
        if ($this->isColumnModified(PUQualificationArchivePeer::P_U_MANDATE_TYPE_ID)) $criteria->add(PUQualificationArchivePeer::P_U_MANDATE_TYPE_ID, $this->p_u_mandate_type_id);
        if ($this->isColumnModified(PUQualificationArchivePeer::DESCRIPTION)) $criteria->add(PUQualificationArchivePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PUQualificationArchivePeer::BEGIN_AT)) $criteria->add(PUQualificationArchivePeer::BEGIN_AT, $this->begin_at);
        if ($this->isColumnModified(PUQualificationArchivePeer::END_AT)) $criteria->add(PUQualificationArchivePeer::END_AT, $this->end_at);
        if ($this->isColumnModified(PUQualificationArchivePeer::CREATED_AT)) $criteria->add(PUQualificationArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PUQualificationArchivePeer::UPDATED_AT)) $criteria->add(PUQualificationArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PUQualificationArchivePeer::ARCHIVED_AT)) $criteria->add(PUQualificationArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PUQualificationArchivePeer::DATABASE_NAME);
        $criteria->add(PUQualificationArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUQualificationArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUQualificationArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PUQualificationArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PUQualificationArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PUQualificationArchivePeer::DEFAULT_STRING_FORMAT);
    }
