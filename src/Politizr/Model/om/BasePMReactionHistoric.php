...
abstract class BasePMReactionHistoric extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PMReactionHistoricPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PMReactionHistoricPeer
     */
     ...
     * @return PMReactionHistoric The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::ID;
        }
    ...
    public function setPDReactionId($v)
    {
        ...
        if ($this->p_d_reaction_id !== $v) {
            ...
            $this->modifiedColumns[] = PMReactionHistoricPeer::P_D_REACTION_ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::P_USER_ID;
        }
    ...
    public function setPObjectId($v)
    {
        ...
        if ($this->p_object_id !== $v) {
            $this->p_object_id = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::P_OBJECT_ID;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::FILE_NAME;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::DESCRIPTION;
        }
    ...
    public function setCopyright($v)
    {
        ...
        if ($this->copyright !== $v) {
            $this->copyright = $v;
            $this->modifiedColumns[] = PMReactionHistoricPeer::COPYRIGHT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMReactionHistoricPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMReactionHistoricPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->p_d_reaction_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 10; // 10 = PMReactionHistoricPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PMReactionHistoric object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PMReactionHistoricPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PMReactionHistoricQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PMReactionHistoricPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PMReactionHistoricPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PMReactionHistoricPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PMReactionHistoricPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PMReactionHistoricPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::P_D_REACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_reaction_id`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::P_OBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_object_id`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::FILE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`file_name`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PMReactionHistoricPeer::COPYRIGHT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_m_reaction_historic` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPDReaction !== null) {
                if (!$this->aPDReaction->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPDReaction->getValidationFailures());
                }
            }
            ...
            if (($retval = PMReactionHistoricPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PMReactionHistoricPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PMReactionHistoric'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PMReactionHistoric'][$this->getPrimaryKey()] = true;
        $keys = PMReactionHistoricPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPDReactionId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPDReactionId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PMReactionHistoricPeer::ID)) $criteria->add(PMReactionHistoricPeer::ID, $this->id);
        if ($this->isColumnModified(PMReactionHistoricPeer::P_D_REACTION_ID)) $criteria->add(PMReactionHistoricPeer::P_D_REACTION_ID, $this->p_d_reaction_id);
        if ($this->isColumnModified(PMReactionHistoricPeer::P_USER_ID)) $criteria->add(PMReactionHistoricPeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PMReactionHistoricPeer::P_OBJECT_ID)) $criteria->add(PMReactionHistoricPeer::P_OBJECT_ID, $this->p_object_id);
        if ($this->isColumnModified(PMReactionHistoricPeer::FILE_NAME)) $criteria->add(PMReactionHistoricPeer::FILE_NAME, $this->file_name);
        if ($this->isColumnModified(PMReactionHistoricPeer::TITLE)) $criteria->add(PMReactionHistoricPeer::TITLE, $this->title);
        if ($this->isColumnModified(PMReactionHistoricPeer::DESCRIPTION)) $criteria->add(PMReactionHistoricPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PMReactionHistoricPeer::COPYRIGHT)) $criteria->add(PMReactionHistoricPeer::COPYRIGHT, $this->copyright);
        if ($this->isColumnModified(PMReactionHistoricPeer::CREATED_AT)) $criteria->add(PMReactionHistoricPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PMReactionHistoricPeer::UPDATED_AT)) $criteria->add(PMReactionHistoricPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PMReactionHistoricPeer::DATABASE_NAME);
        $criteria->add(PMReactionHistoricPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PMReactionHistoric (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PMReactionHistoric Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PMReactionHistoricPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PMReactionHistoricPeer();
        }
    ...
    public function getPDReaction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDReaction === null && ($this->p_d_reaction_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPDReaction->addPMReactionHistorics($this);
             */
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPUser->addPMReactionHistorics($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PMReactionHistoricPeer::DEFAULT_STRING_FORMAT);
    }
