...
abstract class BasePMUserModerated extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PMUserModeratedPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PMUserModeratedPeer
     */
    ...
    /**
     * The value for the p_m_moderation_type_id field.
     * @var        int
     */
    protected $p_m_moderation_type_id;
    ...
    /**
     * @var        PMModerationType
     */
    protected $aPMModerationType;
    ...
    /**
     * Get the [p_m_moderation_type_id] column value.
     *
     * @return int
     */
    public function getPMModerationTypeId()
    {

        return $this->p_m_moderation_type_id;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PMUserModeratedPeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PMUserModeratedPeer::P_USER_ID;
        }
    ...
    /**
     * Set the value of [p_m_moderation_type_id] column.
     *
     * @param  int $v new value
     * @return PMUserModerated The current object (for fluent API support)
     */
    public function setPMModerationTypeId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->p_m_moderation_type_id !== $v) {
            $this->p_m_moderation_type_id = $v;
            $this->modifiedColumns[] = PMUserModeratedPeer::P_M_MODERATION_TYPE_ID;
        }

        if ($this->aPMModerationType !== null && $this->aPMModerationType->getId() !== $v) {
            $this->aPMModerationType = null;
        }


        return $this;
    } // setPMModerationTypeId()
    ...
    public function setPObjectName($v)
    {
        ...
        if ($this->p_object_name !== $v) {
            ...
            $this->modifiedColumns[] = PMUserModeratedPeer::P_OBJECT_NAME;
        }
    ...
    public function setPObjectId($v)
    {
        ...
        if ($this->p_object_id !== $v) {
            $this->p_object_id = $v;
            $this->modifiedColumns[] = PMUserModeratedPeer::P_OBJECT_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMUserModeratedPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMUserModeratedPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPMModerationType !== null && $this->p_m_moderation_type_id !== $this->aPMModerationType->getId()) {
            $this->aPMModerationType = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PMUserModeratedPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PMUserModeratedQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PMUserModeratedPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PMUserModeratedPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                PMUserModeratedPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPMModerationType !== null) {
                if ($this->aPMModerationType->isModified() || $this->aPMModerationType->isNew()) {
                    $affectedRows += $this->aPMModerationType->save($con);
                }
                $this->setPMModerationType($this->aPMModerationType);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PMUserModeratedPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PMUserModeratedPeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PMUserModeratedPeer::P_M_MODERATION_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_m_moderation_type_id`';
        }
        if ($this->isColumnModified(PMUserModeratedPeer::P_OBJECT_NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_m_user_moderated` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`p_user_id`':
                        ...
                        break;
                    case '`p_m_moderation_type_id`':
                        $stmt->bindValue($identifier, $this->p_m_moderation_type_id, PDO::PARAM_INT);
                        break;
                    case '`p_object_name`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPMModerationType !== null) {
                if (!$this->aPMModerationType->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPMModerationType->getValidationFailures());
                }
            }


            if (($retval = PMUserModeratedPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PMUserModeratedPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getPMModerationTypeId();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['PMUserModerated'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PMUserModerated'][$this->getPrimaryKey()] = true;
        $keys = PMUserModeratedPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPMModerationType) {
                $result['PMModerationType'] = $this->aPMModerationType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setPMModerationTypeId($value);
                break;
            case 3:
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PMUserModeratedPeer::ID)) $criteria->add(PMUserModeratedPeer::ID, $this->id);
        if ($this->isColumnModified(PMUserModeratedPeer::P_USER_ID)) $criteria->add(PMUserModeratedPeer::P_USER_ID, $this->p_user_id);
    ...
    {
        $criteria = new Criteria(PMUserModeratedPeer::DATABASE_NAME);
        $criteria->add(PMUserModeratedPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PMUserModerated (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PMUserModerated Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PMUserModeratedPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PMUserModeratedPeer();
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPUser->addPMUserModerateds($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a PMModerationType object.
     *
     * @param                  PMModerationType $v
     * @return PMUserModerated The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPMModerationType(PMModerationType $v = null)
    {
        if ($v === null) {
            $this->setPMModerationTypeId(NULL);
        } else {
            $this->setPMModerationTypeId($v->getId());
        }

        $this->aPMModerationType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the PMModerationType object, it will not be re-added.
        if ($v !== null) {
            $v->addPMUserModerated($this);
        }
    ...
    /**
     * Get the associated PMModerationType object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return PMModerationType The associated PMModerationType object.
     * @throws PropelException
     */
    public function getPMModerationType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPMModerationType === null && ($this->p_m_moderation_type_id !== null) && $doQuery) {
            $this->aPMModerationType = PMModerationTypeQuery::create()->findPk($this->p_m_moderation_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPMModerationType->addPMUserModerateds($this);
             */
        }

        return $this->aPMModerationType;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPMModerationType instanceof Persistent) {
              $this->aPMModerationType->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(PMUserModeratedPeer::DEFAULT_STRING_FORMAT);
    }
