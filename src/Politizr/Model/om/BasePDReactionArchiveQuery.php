...
abstract class BasePDReactionArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `p_user_id`, `p_d_debate_id`, `title`, `summary`, `description`, `more_info`, `note_pos`, `note_neg`, `published`, `published_at`, `published_by`, `online`, `created_at`, `updated_at`, `archived_at` FROM `p_d_reaction_archive` WHERE `id` = :p0';
        try {
