...
abstract class BasePDDCommentArchiveQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Politizr\\Model\\PDDCommentArchive', $modelAlias = null)
    {
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new PDDCommentArchiveQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT `id`, `p_user_id`, `p_d_debate_id`, `description`, `paragraph_no`, `note_pos`, `note_neg`, `published_at`, `published_by`, `online`, `created_at`, `updated_at`, `archived_at` FROM `p_d_d_comment_archive` WHERE `id` = :p0';
        try {
