...
abstract class BasePTTagType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PTTagTypePeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PTTagTypePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PTTagTypePeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PTTagTypePeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PTTagTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PTTagTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PTTagTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PTTagType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PTTagTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PTTagTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PTTagTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PTTagTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PTTagTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PTTagTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->pTagsScheduledForDeletion !== null) {
                if (!$this->pTagsScheduledForDeletion->isEmpty()) {
                    PTagQuery::create()
                        ->filterByPrimaryKeys($this->pTagsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PTTagTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PTTagTypePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PTTagTypePeer::DESCRIPTION)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_t_tag_type` (%s) VALUES (%s)',
    ...
    {
        $pos = PTTagTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PTTagType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PTTagType'][$this->getPrimaryKey()] = true;
        $keys = PTTagTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PTTagTypePeer::ID)) $criteria->add(PTTagTypePeer::ID, $this->id);
        if ($this->isColumnModified(PTTagTypePeer::TITLE)) $criteria->add(PTTagTypePeer::TITLE, $this->title);
        if ($this->isColumnModified(PTTagTypePeer::DESCRIPTION)) $criteria->add(PTTagTypePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PTTagTypePeer::CREATED_AT)) $criteria->add(PTTagTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PTTagTypePeer::UPDATED_AT)) $criteria->add(PTTagTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PTTagTypePeer::DATABASE_NAME);
        $criteria->add(PTTagTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PTTagType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PTTagType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PTTagTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PTTagTypePeer();
        }
     ...
     * If this PTTagType is new, it will return
    ...
    public function removePTag($pTag)
    {
        if ($this->getPTags()->contains($pTag)) {
            ...
            $this->pTagsScheduledForDeletion[]= clone $pTag;
            $pTag->setPTTagType(null);
        }
     ...
     * Otherwise if this PTTagType is new, it will return
     * an empty collection; or if this PTTagType has previously
     * been saved, it will retrieve related PTags from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PTTagType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|PTag[] List of PTag objects
     */
    public function getPTagsJoinPUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PTagQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|PTag[] List of PTag objects
     */
    public function getPTagsJoinPOwner($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PTagQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PTTagTypePeer::DEFAULT_STRING_FORMAT);
    }
