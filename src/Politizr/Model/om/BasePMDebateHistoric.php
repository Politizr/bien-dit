...
abstract class BasePMDebateHistoric extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PMDebateHistoricPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PMDebateHistoricPeer
     */
     ...
     * @return PMDebateHistoric The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::ID;
        }
    ...
    public function setPDDebateId($v)
    {
        ...
        if ($this->p_d_debate_id !== $v) {
            ...
            $this->modifiedColumns[] = PMDebateHistoricPeer::P_D_DEBATE_ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::P_USER_ID;
        }
    ...
    public function setPObjectId($v)
    {
        ...
        if ($this->p_object_id !== $v) {
            $this->p_object_id = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::P_OBJECT_ID;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::FILE_NAME;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::DESCRIPTION;
        }
    ...
    public function setCopyright($v)
    {
        ...
        if ($this->copyright !== $v) {
            $this->copyright = $v;
            $this->modifiedColumns[] = PMDebateHistoricPeer::COPYRIGHT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMDebateHistoricPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMDebateHistoricPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = PMDebateHistoricPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PMDebateHistoric object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PMDebateHistoricPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PMDebateHistoricQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PMDebateHistoricPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PMDebateHistoricPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PMDebateHistoricPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PMDebateHistoricPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PMDebateHistoricPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::P_D_DEBATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_debate_id`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::P_OBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_object_id`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::FILE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`file_name`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PMDebateHistoricPeer::COPYRIGHT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_m_debate_historic` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PMDebateHistoricPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PMDebateHistoricPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PMDebateHistoric'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PMDebateHistoric'][$this->getPrimaryKey()] = true;
        $keys = PMDebateHistoricPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PMDebateHistoricPeer::ID)) $criteria->add(PMDebateHistoricPeer::ID, $this->id);
        if ($this->isColumnModified(PMDebateHistoricPeer::P_D_DEBATE_ID)) $criteria->add(PMDebateHistoricPeer::P_D_DEBATE_ID, $this->p_d_debate_id);
        if ($this->isColumnModified(PMDebateHistoricPeer::P_USER_ID)) $criteria->add(PMDebateHistoricPeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PMDebateHistoricPeer::P_OBJECT_ID)) $criteria->add(PMDebateHistoricPeer::P_OBJECT_ID, $this->p_object_id);
        if ($this->isColumnModified(PMDebateHistoricPeer::FILE_NAME)) $criteria->add(PMDebateHistoricPeer::FILE_NAME, $this->file_name);
        if ($this->isColumnModified(PMDebateHistoricPeer::TITLE)) $criteria->add(PMDebateHistoricPeer::TITLE, $this->title);
        if ($this->isColumnModified(PMDebateHistoricPeer::DESCRIPTION)) $criteria->add(PMDebateHistoricPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PMDebateHistoricPeer::COPYRIGHT)) $criteria->add(PMDebateHistoricPeer::COPYRIGHT, $this->copyright);
        if ($this->isColumnModified(PMDebateHistoricPeer::CREATED_AT)) $criteria->add(PMDebateHistoricPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PMDebateHistoricPeer::UPDATED_AT)) $criteria->add(PMDebateHistoricPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PMDebateHistoricPeer::DATABASE_NAME);
        $criteria->add(PMDebateHistoricPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PMDebateHistoric (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PMDebateHistoric Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PMDebateHistoricPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PMDebateHistoricPeer();
        }
    ...
    public function getPDDebate(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDDebate === null && ($this->p_d_debate_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPDDebate->addPMDebateHistorics($this);
             */
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPUser->addPMDebateHistorics($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PMDebateHistoricPeer::DEFAULT_STRING_FORMAT);
    }
