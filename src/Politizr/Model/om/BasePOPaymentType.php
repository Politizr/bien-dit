...
abstract class BasePOPaymentType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\POPaymentTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        POPaymentTypePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = POPaymentTypePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = POPaymentTypePeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = POPaymentTypePeer::DESCRIPTION;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = POPaymentTypePeer::ONLINE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = POPaymentTypePeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = POPaymentTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(POPaymentTypePeer::CREATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(POPaymentTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                POPaymentTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(POPaymentTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(POPaymentTypePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(POPaymentTypePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(POPaymentTypePeer::ONLINE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = POPaymentTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = POPaymentTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['POPaymentType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['POPaymentType'][$this->getPrimaryKey()] = true;
        $keys = POPaymentTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(POPaymentTypePeer::ID)) $criteria->add(POPaymentTypePeer::ID, $this->id);
        if ($this->isColumnModified(POPaymentTypePeer::TITLE)) $criteria->add(POPaymentTypePeer::TITLE, $this->title);
        if ($this->isColumnModified(POPaymentTypePeer::DESCRIPTION)) $criteria->add(POPaymentTypePeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(POPaymentTypePeer::DATABASE_NAME);
        $criteria->add(POPaymentTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of POPaymentType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return POPaymentType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return POPaymentTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new POPaymentTypePeer();
        }
     ...
     * If this POPaymentType is new, it will return
     ...
     * Otherwise if this POPaymentType is new, it will return
     * an empty collection; or if this POPaymentType has previously
     * been saved, it will retrieve related POrders from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in POPaymentType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(POPaymentTypePeer::DEFAULT_STRING_FORMAT);
    }
