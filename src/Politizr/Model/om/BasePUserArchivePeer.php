...
abstract class BasePUserArchivePeer
{
    ...
    const TM_CLASS = 'PUserArchiveTableMap';
    ...
    const P_U_TYPE_ID = 'p_user_archive.p_u_type_id';
    ...
    const SUMMARY = 'p_user_archive.summary';
    ...
    /**
     * An identiy map to hold any loaded instances of PUserArchive objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Provider', 'ProviderId', 'Nickname', 'Realname', 'Username', 'UsernameCanonical', 'Email', 'EmailCanonical', 'Enabled', 'Salt', 'Password', 'LastLogin', 'Locked', 'Expired', 'ExpiresAt', 'ConfirmationToken', 'PasswordRequestedAt', 'CredentialsExpired', 'CredentialsExpireAt', 'Roles', 'PUTypeId', 'PUStatusId', 'FileName', 'Gender', 'Firstname', 'Name', 'Birthday', 'Summary', 'Biography', 'Website', 'Twitter', 'Facebook', 'Phone', 'Newsletter', 'LastConnect', 'Online', 'CreatedAt', 'UpdatedAt', 'ArchivedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'provider', 'providerId', 'nickname', 'realname', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'credentialsExpired', 'credentialsExpireAt', 'roles', 'pUTypeId', 'pUStatusId', 'fileName', 'gender', 'firstname', 'name', 'birthday', 'summary', 'biography', 'website', 'twitter', 'facebook', 'phone', 'newsletter', 'lastConnect', 'online', 'createdAt', 'updatedAt', 'archivedAt', ),
        BasePeer::TYPE_COLNAME => array (PUserArchivePeer::ID, PUserArchivePeer::PROVIDER, PUserArchivePeer::PROVIDER_ID, PUserArchivePeer::NICKNAME, PUserArchivePeer::REALNAME, PUserArchivePeer::USERNAME, PUserArchivePeer::USERNAME_CANONICAL, PUserArchivePeer::EMAIL, PUserArchivePeer::EMAIL_CANONICAL, PUserArchivePeer::ENABLED, PUserArchivePeer::SALT, PUserArchivePeer::PASSWORD, PUserArchivePeer::LAST_LOGIN, PUserArchivePeer::LOCKED, PUserArchivePeer::EXPIRED, PUserArchivePeer::EXPIRES_AT, PUserArchivePeer::CONFIRMATION_TOKEN, PUserArchivePeer::PASSWORD_REQUESTED_AT, PUserArchivePeer::CREDENTIALS_EXPIRED, PUserArchivePeer::CREDENTIALS_EXPIRE_AT, PUserArchivePeer::ROLES, PUserArchivePeer::P_U_TYPE_ID, PUserArchivePeer::P_U_STATUS_ID, PUserArchivePeer::FILE_NAME, PUserArchivePeer::GENDER, PUserArchivePeer::FIRSTNAME, PUserArchivePeer::NAME, PUserArchivePeer::BIRTHDAY, PUserArchivePeer::SUMMARY, PUserArchivePeer::BIOGRAPHY, PUserArchivePeer::WEBSITE, PUserArchivePeer::TWITTER, PUserArchivePeer::FACEBOOK, PUserArchivePeer::PHONE, PUserArchivePeer::NEWSLETTER, PUserArchivePeer::LAST_CONNECT, PUserArchivePeer::ONLINE, PUserArchivePeer::CREATED_AT, PUserArchivePeer::UPDATED_AT, PUserArchivePeer::ARCHIVED_AT, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PUserArchivePeer::P_U_TYPE_ID);
            ...
            $criteria->addSelectColumn(PUserArchivePeer::SUMMARY);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePUserArchivePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PUserArchiveTableMap());
      }
    }
