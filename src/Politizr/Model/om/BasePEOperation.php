...
abstract class BasePEOperation extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BasePEOperation object.
     * @see        applyDefaults()
     */
    ...
    public function setNewSubjectLink($v)
    {
        ...
        if ($this->new_subject_link !== $v) {
            ...
            $this->modifiedColumns[] = PEOperationPeer::NEW_SUBJECT_LINK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 14; // 14 = PEOperationPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PEOperationPeer::NEW_SUBJECT_LINK)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PEOperationPeer::NEW_SUBJECT_LINK)) $criteria->add(PEOperationPeer::NEW_SUBJECT_LINK, $this->new_subject_link);
    ...
    * If permanent UUID, throw exception p_e_operation.uuid*/
    ...
    public function populateFromArchive($archive, $populateAutoIncrementPrimaryKeys = false) {
        ...
        $this->setNewSubjectLink($archive->getNewSubjectLink());
