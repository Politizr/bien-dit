...
abstract class BasePOrderArchive extends BaseObject implements Persistent
{
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = POrderArchivePeer::UUID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 28; // 28 = POrderArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(POrderArchivePeer::UUID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(POrderArchivePeer::UUID)) $criteria->add(POrderArchivePeer::UUID, $this->uuid);
