...
abstract class BasePDReactionArchive extends BaseObject implements Persistent
{
    ...
    public function setFbAdId($v)
    {
        ...
        if ($this->fb_ad_id !== $v) {
            $this->fb_ad_id = $v;
            $this->modifiedColumns[] = PDReactionArchivePeer::FB_AD_ID;
        }
    ...
    public function setWantBoost($v)
    {
        ...
        if ($this->want_boost !== $v) {
            $this->want_boost = $v;
            $this->modifiedColumns[] = PDReactionArchivePeer::WANT_BOOST;
        }
    ...
    public function setIndexedAt($v)
    {
        ...
        if ($this->indexed_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDReactionArchivePeer::INDEXED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tree_left = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
            $this->tree_right = ($row[$startcol + 32] !== null) ? (int) $row[$startcol + 32] : null;
            $this->tree_level = ($row[$startcol + 33] !== null) ? (int) $row[$startcol + 33] : null;
            $this->archived_at = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
            $this->resetModified();
            ...
            return $startcol + 35; // 35 = PDReactionArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::FB_AD_ID)) {
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::WANT_BOOST)) {
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::INDEXED_AT)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[31] => $this->getTreeLeft(),
            $keys[32] => $this->getTreeRight(),
            $keys[33] => $this->getTreeLevel(),
            $keys[34] => $this->getArchivedAt(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[31], $arr)) $this->setTreeLeft($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setTreeRight($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setTreeLevel($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setArchivedAt($arr[$keys[34]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::FB_AD_ID)) $criteria->add(PDReactionArchivePeer::FB_AD_ID, $this->fb_ad_id);
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::WANT_BOOST)) $criteria->add(PDReactionArchivePeer::WANT_BOOST, $this->want_boost);
        ...
        if ($this->isColumnModified(PDReactionArchivePeer::INDEXED_AT)) $criteria->add(PDReactionArchivePeer::INDEXED_AT, $this->indexed_at);
