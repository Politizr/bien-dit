...
abstract class BasePMEmailing extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PMEmailingPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PMEmailingPeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PMEmailingPeer::P_USER_ID;
        }
    ...
    public function setPNEmailId($v)
    {
        ...
        if ($this->p_n_email_id !== $v) {
            $this->p_n_email_id = $v;
            $this->modifiedColumns[] = PMEmailingPeer::P_N_EMAIL_ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PMEmailingPeer::TITLE;
        }
    ...
    public function setHtmlBody($v)
    {
        ...
        if ($this->html_body !== $v) {
            $this->html_body = $v;
            $this->modifiedColumns[] = PMEmailingPeer::HTML_BODY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMEmailingPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMEmailingPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PMEmailingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PMEmailingQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PMEmailingPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PMEmailingPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PMEmailingPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PMEmailingPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PMEmailingPeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PMEmailingPeer::P_N_EMAIL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_n_email_id`';
        }
        if ($this->isColumnModified(PMEmailingPeer::TITLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_m_emailing` (%s) VALUES (%s)',
    ...
    {
        $pos = PMEmailingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PMEmailing'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PMEmailing'][$this->getPrimaryKey()] = true;
        $keys = PMEmailingPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PMEmailingPeer::ID)) $criteria->add(PMEmailingPeer::ID, $this->id);
        if ($this->isColumnModified(PMEmailingPeer::P_USER_ID)) $criteria->add(PMEmailingPeer::P_USER_ID, $this->p_user_id);
    ...
    {
        $criteria = new Criteria(PMEmailingPeer::DATABASE_NAME);
        $criteria->add(PMEmailingPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PMEmailing (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PMEmailing Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PMEmailingPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PMEmailingPeer();
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPUser->addPMEmailings($this);
             */
        }
    ...
    public function getPNEmail(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPNEmail === null && ($this->p_n_email_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPNEmail->addPMEmailings($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PMEmailingPeer::DEFAULT_STRING_FORMAT);
    }
