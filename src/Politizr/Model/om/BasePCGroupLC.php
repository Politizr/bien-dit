...
abstract class BasePCGroupLC extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PCGroupLCPeer';
     ...
     * @return PCGroupLC The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PCGroupLCPeer::ID;
        }
    ...
    public function setPCircleId($v)
    {
        ...
        if ($this->p_circle_id !== $v) {
            $this->p_circle_id = $v;
            $this->modifiedColumns[] = PCGroupLCPeer::P_CIRCLE_ID;
        }
    ...
    public function setPLCityId($v)
    {
        ...
        if ($this->p_l_city_id !== $v) {
            $this->p_l_city_id = $v;
            $this->modifiedColumns[] = PCGroupLCPeer::P_L_CITY_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCGroupLCPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCGroupLCPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PCGroupLCPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PCGroupLC object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PCGroupLCPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PCGroupLCQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PCGroupLCPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PCGroupLCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PCGroupLCPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PCGroupLCPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PCGroupLCPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PCGroupLCPeer::P_CIRCLE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_circle_id`';
        }
        if ($this->isColumnModified(PCGroupLCPeer::P_L_CITY_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_c_group_l_c` (%s) VALUES (%s)',
    ...
    {
        $pos = PCGroupLCPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PCGroupLC'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PCGroupLC'][$this->getPrimaryKey()] = true;
        $keys = PCGroupLCPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PCGroupLCPeer::ID)) $criteria->add(PCGroupLCPeer::ID, $this->id);
        if ($this->isColumnModified(PCGroupLCPeer::P_CIRCLE_ID)) $criteria->add(PCGroupLCPeer::P_CIRCLE_ID, $this->p_circle_id);
        if ($this->isColumnModified(PCGroupLCPeer::P_L_CITY_ID)) $criteria->add(PCGroupLCPeer::P_L_CITY_ID, $this->p_l_city_id);
        if ($this->isColumnModified(PCGroupLCPeer::CREATED_AT)) $criteria->add(PCGroupLCPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PCGroupLCPeer::UPDATED_AT)) $criteria->add(PCGroupLCPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PCGroupLCPeer::DATABASE_NAME);
        $criteria->add(PCGroupLCPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PCGroupLC (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PCGroupLC Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PCGroupLCPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PCGroupLCPeer();
        }
    ...
    public function getPCircle(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPCircle === null && ($this->p_circle_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPCircle->addPCGroupLCs($this);
             */
        }
    ...
    public function getPLCity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPLCity === null && ($this->p_l_city_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPLCity->addPCGroupLCs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PCGroupLCPeer::DEFAULT_STRING_FORMAT);
    }
