...
abstract class BasePUTaggedT extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUTaggedTPeer';
     ...
     * @var        PUser
     */
    protected $aPuTaggedTPUser;

    /**
     * @var        PTag
     */
    protected $aPuTaggedTPTag;
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PUTaggedTPeer::P_USER_ID;
        }

        if ($this->aPuTaggedTPUser !== null && $this->aPuTaggedTPUser->getId() !== $v) {
            $this->aPuTaggedTPUser = null;
        }
    ...
    public function setPTagId($v)
    {
        ...
        if ($this->p_tag_id !== $v) {
            $this->p_tag_id = $v;
            $this->modifiedColumns[] = PUTaggedTPeer::P_TAG_ID;
        }

        if ($this->aPuTaggedTPTag !== null && $this->aPuTaggedTPTag->getId() !== $v) {
            $this->aPuTaggedTPTag = null;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUTaggedTPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUTaggedTPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPuTaggedTPUser !== null && $this->p_user_id !== $this->aPuTaggedTPUser->getId()) {
            $this->aPuTaggedTPUser = null;
        }
        if ($this->aPuTaggedTPTag !== null && $this->p_tag_id !== $this->aPuTaggedTPTag->getId()) {
            $this->aPuTaggedTPTag = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUTaggedTPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PUTaggedTQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUTaggedTPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUTaggedTPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                PUTaggedTPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPuTaggedTPUser !== null) {
                if ($this->aPuTaggedTPUser->isModified() || $this->aPuTaggedTPUser->isNew()) {
                    $affectedRows += $this->aPuTaggedTPUser->save($con);
                }
                $this->setPuTaggedTPUser($this->aPuTaggedTPUser);
            }

            if ($this->aPuTaggedTPTag !== null) {
                if ($this->aPuTaggedTPTag->isModified() || $this->aPuTaggedTPTag->isNew()) {
                    $affectedRows += $this->aPuTaggedTPTag->save($con);
                }
                $this->setPuTaggedTPTag($this->aPuTaggedTPTag);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_tagged_t` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPuTaggedTPUser !== null) {
                if (!$this->aPuTaggedTPUser->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPuTaggedTPUser->getValidationFailures());
                }
            }

            if ($this->aPuTaggedTPTag !== null) {
                if (!$this->aPuTaggedTPTag->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPuTaggedTPTag->getValidationFailures());
                }
            }


            if (($retval = PUTaggedTPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PUTaggedTPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPuTaggedTPUser) {
                $result['PuTaggedTPUser'] = $this->aPuTaggedTPUser->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aPuTaggedTPTag) {
                $result['PuTaggedTPTag'] = $this->aPuTaggedTPTag->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of PUTaggedT (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUTaggedT Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PUTaggedTPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PUTaggedTPeer();
        }
     ...
     * @throws PropelException
     */
    public function setPuTaggedTPUser(PUser $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getPuTaggedTPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPuTaggedTPUser === null && ($this->p_user_id !== null) && $doQuery) {
            $this->aPuTaggedTPUser = PUserQuery::create()->findPk($this->p_user_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPuTaggedTPUser->addPuTaggedTPUsers($this);
             */
        }

        return $this->aPuTaggedTPUser;
    }
     ...
     * @throws PropelException
     */
    public function setPuTaggedTPTag(PTag $v = null)
    {
        if ($v === null) {
            $this->setPTagId(NULL);
        } else {
     ...
     * @throws PropelException
     */
    public function getPuTaggedTPTag(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPuTaggedTPTag === null && ($this->p_tag_id !== null) && $doQuery) {
            $this->aPuTaggedTPTag = PTagQuery::create()->findPk($this->p_tag_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPuTaggedTPTag->addPuTaggedTPTags($this);
             */
        }

        return $this->aPuTaggedTPTag;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPuTaggedTPUser instanceof Persistent) {
              $this->aPuTaggedTPUser->clearAllReferences($deep);
            }
            if ($this->aPuTaggedTPTag instanceof Persistent) {
              $this->aPuTaggedTPTag->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(PUTaggedTPeer::DEFAULT_STRING_FORMAT);
    }
