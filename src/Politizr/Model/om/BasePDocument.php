...
abstract class BasePDocument extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BasePDocument object.
     * @see        applyDefaults()
     */
    ...
    public function setCopyright($v)
    {
        ...
        if ($this->copyright !== $v) {
            $this->copyright = $v;
            $this->modifiedColumns[] = PDocumentPeer::COPYRIGHT;
        }
    ...
    public function setWithShadow($v)
    {
        ...
        if ($this->with_shadow !== $v) {
            $this->with_shadow = $v;
            $this->modifiedColumns[] = PDocumentPeer::WITH_SHADOW;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 17; // 17 = PDocumentPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDocumentPeer::COPYRIGHT)) {
            $modifiedColumns[':p' . $index++]  = '`copyright`';
        }
        if ($this->isColumnModified(PDocumentPeer::WITH_SHADOW)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDocumentPeer::COPYRIGHT)) $criteria->add(PDocumentPeer::COPYRIGHT, $this->copyright);
        if ($this->isColumnModified(PDocumentPeer::WITH_SHADOW)) $criteria->add(PDocumentPeer::WITH_SHADOW, $this->with_shadow);
