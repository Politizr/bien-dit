...
abstract class BasePDComment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDCommentPeer';
    ...
    /**
     * Initializes internal state of BasePDComment object.
     * @see        applyDefaults()
     */
     ...
     * @return PDComment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDCommentPeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PDCommentPeer::P_USER_ID;
        }
    ...
    public function setPDocumentId($v)
    {
        ...
        if ($this->p_document_id !== $v) {
            ...
            $this->modifiedColumns[] = PDCommentPeer::P_DOCUMENT_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PDCommentPeer::DESCRIPTION;
        }
    ...
    public function setParagraphNo($v)
    {
        ...
        if ($this->paragraph_no !== $v) {
            $this->paragraph_no = $v;
            $this->modifiedColumns[] = PDCommentPeer::PARAGRAPH_NO;
        }
    ...
    public function setNotePos($v)
    {
        ...
        if ($this->note_pos !== $v) {
            $this->note_pos = $v;
            $this->modifiedColumns[] = PDCommentPeer::NOTE_POS;
        }
    ...
    public function setNoteNeg($v)
    {
        ...
        if ($this->note_neg !== $v) {
            $this->note_neg = $v;
            $this->modifiedColumns[] = PDCommentPeer::NOTE_NEG;
        }
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->published_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentPeer::PUBLISHED_AT;
            }
    ...
    public function setPublishedBy($v)
    {
        ...
        if ($this->published_by !== $v) {
            $this->published_by = $v;
            $this->modifiedColumns[] = PDCommentPeer::PUBLISHED_BY;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[] = PDCommentPeer::ONLINE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDCommentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = PDCommentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PDComment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDCommentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PDCommentQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // archivable behavior
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling PDCommentQuery::delete().
                } else {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PDCommentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PDCommentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PDCommentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PDCommentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDCommentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDCommentPeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PDCommentPeer::P_DOCUMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_document_id`';
        }
        if ($this->isColumnModified(PDCommentPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PDCommentPeer::PARAGRAPH_NO)) {
            $modifiedColumns[':p' . $index++]  = '`paragraph_no`';
        }
        if ($this->isColumnModified(PDCommentPeer::NOTE_POS)) {
            $modifiedColumns[':p' . $index++]  = '`note_pos`';
        }
        if ($this->isColumnModified(PDCommentPeer::NOTE_NEG)) {
            $modifiedColumns[':p' . $index++]  = '`note_neg`';
        }
        if ($this->isColumnModified(PDCommentPeer::PUBLISHED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`published_at`';
        }
        if ($this->isColumnModified(PDCommentPeer::PUBLISHED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`published_by`';
        }
        if ($this->isColumnModified(PDCommentPeer::ONLINE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_d_comment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDCommentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDCommentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDComment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDComment'][$this->getPrimaryKey()] = true;
        $keys = PDCommentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDCommentPeer::ID)) $criteria->add(PDCommentPeer::ID, $this->id);
        if ($this->isColumnModified(PDCommentPeer::P_USER_ID)) $criteria->add(PDCommentPeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PDCommentPeer::P_DOCUMENT_ID)) $criteria->add(PDCommentPeer::P_DOCUMENT_ID, $this->p_document_id);
        if ($this->isColumnModified(PDCommentPeer::DESCRIPTION)) $criteria->add(PDCommentPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PDCommentPeer::PARAGRAPH_NO)) $criteria->add(PDCommentPeer::PARAGRAPH_NO, $this->paragraph_no);
        if ($this->isColumnModified(PDCommentPeer::NOTE_POS)) $criteria->add(PDCommentPeer::NOTE_POS, $this->note_pos);
        if ($this->isColumnModified(PDCommentPeer::NOTE_NEG)) $criteria->add(PDCommentPeer::NOTE_NEG, $this->note_neg);
        if ($this->isColumnModified(PDCommentPeer::PUBLISHED_AT)) $criteria->add(PDCommentPeer::PUBLISHED_AT, $this->published_at);
        if ($this->isColumnModified(PDCommentPeer::PUBLISHED_BY)) $criteria->add(PDCommentPeer::PUBLISHED_BY, $this->published_by);
        if ($this->isColumnModified(PDCommentPeer::ONLINE)) $criteria->add(PDCommentPeer::ONLINE, $this->online);
        if ($this->isColumnModified(PDCommentPeer::CREATED_AT)) $criteria->add(PDCommentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PDCommentPeer::UPDATED_AT)) $criteria->add(PDCommentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PDCommentPeer::DATABASE_NAME);
        $criteria->add(PDCommentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDComment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDComment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDCommentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDCommentPeer();
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPUser->addPDComments($this);
             */
        }
    ...
    public function getPDocument(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDocument === null && ($this->p_document_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPDocument->addPDComments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PDCommentPeer::DEFAULT_STRING_FORMAT);
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return     PDCommentArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(PropelPDO $con = null)
    {
        ...
        $archive = PDCommentArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     PDCommentArchive The archive object based on this object
     */
     ...
     *
     * @param      PDCommentArchive $archive An archived object based on the same class
