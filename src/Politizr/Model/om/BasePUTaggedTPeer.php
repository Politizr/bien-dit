...
abstract class BasePUTaggedTPeer
{
    ...
    const TM_CLASS = 'PUTaggedTTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of PUTaggedT objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PUTaggedTPeer::P_USER_ID, PUTaggedTPeer::P_TAG_ID, PUTaggedTPeer::CREATED_AT, PUTaggedTPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PUTaggedTPeer::P_USER_ID => 0, PUTaggedTPeer::P_TAG_ID => 1, PUTaggedTPeer::CREATED_AT => 2, PUTaggedTPeer::UPDATED_AT => 3, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePUTaggedTPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PUTaggedTTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PUTaggedTPeer::P_USER_ID);
            $value = $criteria->remove(PUTaggedTPeer::P_USER_ID);
            if ($value) {
                $selectCriteria->add(PUTaggedTPeer::P_USER_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PUTaggedTPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(PUTaggedTPeer::P_TAG_ID);
            $value = $criteria->remove(PUTaggedTPeer::P_TAG_ID);
            if ($value) {
                $selectCriteria->add(PUTaggedTPeer::P_TAG_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PUTaggedTPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(PUTaggedTPeer::P_USER_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(PUTaggedTPeer::P_TAG_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                PUTaggedTPeer::removeInstanceFromPool($value);
            }
        }
    ...
    public static function retrieveByPK($p_user_id, $p_tag_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $p_user_id, (string) $p_tag_id));
         if (null !== ($obj = PUTaggedTPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(PUTaggedTPeer::DATABASE_NAME);
        $criteria->add(PUTaggedTPeer::P_USER_ID, $p_user_id);
        $criteria->add(PUTaggedTPeer::P_TAG_ID, $p_tag_id);
