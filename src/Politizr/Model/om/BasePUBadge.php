...
abstract class BasePUBadge extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUBadgePeer';
     ...
     * @return PUBadge The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUBadgePeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PUBadgePeer::P_USER_ID;
        }
    ...
    public function setPRBadgeId($v)
    {
        ...
        if ($this->p_r_badge_id !== $v) {
            $this->p_r_badge_id = $v;
            $this->modifiedColumns[] = PUBadgePeer::P_R_BADGE_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUBadgePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUBadgePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PUBadgePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PUBadge object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUBadgePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PUBadgeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUBadgePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PUBadgePeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUBadgePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                PUBadgePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUBadgePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUBadgePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PUBadgePeer::P_R_BADGE_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_badge` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PUBadgePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PUBadgePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUBadge'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUBadge'][$this->getPrimaryKey()] = true;
        $keys = PUBadgePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUBadgePeer::ID)) $criteria->add(PUBadgePeer::ID, $this->id);
        if ($this->isColumnModified(PUBadgePeer::P_USER_ID)) $criteria->add(PUBadgePeer::P_USER_ID, $this->p_user_id);
        if ($this->isColumnModified(PUBadgePeer::P_R_BADGE_ID)) $criteria->add(PUBadgePeer::P_R_BADGE_ID, $this->p_r_badge_id);
        if ($this->isColumnModified(PUBadgePeer::CREATED_AT)) $criteria->add(PUBadgePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PUBadgePeer::UPDATED_AT)) $criteria->add(PUBadgePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PUBadgePeer::DATABASE_NAME);
        $criteria->add(PUBadgePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUBadge (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUBadge Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPRBadge(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPRBadge === null && ($this->p_r_badge_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPRBadge->addPUBadges($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PUBadgePeer::DEFAULT_STRING_FORMAT);
    }
