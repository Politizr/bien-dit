...
abstract class BasePUMandate extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUMandatePeer';
     ...
     * @var        PQMandate
     */
    protected $aPQMandate;

    /**
     * @var        PQOrganization
     */
    protected $aPQOrganization;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUMandatePeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PUMandatePeer::UUID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PUMandatePeer::P_USER_ID;
        }
    ...
    public function setPQTypeId($v)
    {
        ...
        if ($this->p_q_type_id !== $v) {
            $this->p_q_type_id = $v;
            $this->modifiedColumns[] = PUMandatePeer::P_Q_TYPE_ID;
        }
    ...
    public function setPQMandateId($v)
    {
        ...
        if ($this->p_q_mandate_id !== $v) {
            ...
            $this->modifiedColumns[] = PUMandatePeer::P_Q_MANDATE_ID;
        }

        if ($this->aPQMandate !== null && $this->aPQMandate->getId() !== $v) {
            $this->aPQMandate = null;
        }
    ...
    public function setPQOrganizationId($v)
    {
        ...
        if ($this->p_q_organization_id !== $v) {
            ...
            $this->modifiedColumns[] = PUMandatePeer::P_Q_ORGANIZATION_ID;
        }

        if ($this->aPQOrganization !== null && $this->aPQOrganization->getId() !== $v) {
            $this->aPQOrganization = null;
        }
    ...
    public function setBeginAt($v)
    {
        ...
        if ($this->begin_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUMandatePeer::BEGIN_AT;
            }
    ...
    public function setEndAt($v)
    {
        ...
        if ($this->end_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUMandatePeer::END_AT;
            }
        } // if either are not null
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUMandatePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUMandatePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->p_q_type_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->p_q_mandate_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->p_q_organization_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->localization = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->begin_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->end_at = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 11; // 11 = PUMandatePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PUMandate object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPQMandate !== null && $this->p_q_mandate_id !== $this->aPQMandate->getId()) {
            $this->aPQMandate = null;
        }
        if ($this->aPQOrganization !== null && $this->p_q_organization_id !== $this->aPQOrganization->getId()) {
            $this->aPQOrganization = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUMandatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PUMandateQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // archivable behavior
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling PUMandateQuery::delete().
                } else {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUMandatePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PUMandatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUMandatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PUMandatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPQMandate !== null) {
                if ($this->aPQMandate->isModified() || $this->aPQMandate->isNew()) {
                    $affectedRows += $this->aPQMandate->save($con);
                }
                $this->setPQMandate($this->aPQMandate);
            }

            if ($this->aPQOrganization !== null) {
                if ($this->aPQOrganization->isModified() || $this->aPQOrganization->isNew()) {
                    $affectedRows += $this->aPQOrganization->save($con);
                }
                $this->setPQOrganization($this->aPQOrganization);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUMandatePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUMandatePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(PUMandatePeer::P_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_user_id`';
        }
        if ($this->isColumnModified(PUMandatePeer::P_Q_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_q_type_id`';
        }
        if ($this->isColumnModified(PUMandatePeer::P_Q_MANDATE_ID)) {
        ...
        if ($this->isColumnModified(PUMandatePeer::END_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_mandate` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPQMandate !== null) {
                if (!$this->aPQMandate->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPQMandate->getValidationFailures());
                }
            }

            if ($this->aPQOrganization !== null) {
                if (!$this->aPQOrganization->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPQOrganization->getValidationFailures());
                }
            }


            if (($retval = PUMandatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PUMandatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUMandate'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUMandate'][$this->getPrimaryKey()] = true;
        $keys = PUMandatePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUuid(),
            $keys[2] => $this->getPUserId(),
            $keys[3] => $this->getPQTypeId(),
            $keys[4] => $this->getPQMandateId(),
            $keys[5] => $this->getPQOrganizationId(),
            $keys[6] => $this->getLocalization(),
            $keys[7] => $this->getBeginAt(),
            $keys[8] => $this->getEndAt(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPQMandate) {
                $result['PQMandate'] = $this->aPQMandate->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aPQOrganization) {
                $result['PQOrganization'] = $this->aPQOrganization->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setPQTypeId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setPQMandateId($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setPQOrganizationId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setLocalization($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setBeginAt($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setEndAt($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUMandatePeer::ID)) $criteria->add(PUMandatePeer::ID, $this->id);
        if ($this->isColumnModified(PUMandatePeer::UUID)) $criteria->add(PUMandatePeer::UUID, $this->uuid);
        if ($this->isColumnModified(PUMandatePeer::P_USER_ID)) $criteria->add(PUMandatePeer::P_USER_ID, $this->p_user_id);
        ...
        if ($this->isColumnModified(PUMandatePeer::UPDATED_AT)) $criteria->add(PUMandatePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PUMandatePeer::DATABASE_NAME);
        $criteria->add(PUMandatePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUMandate (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUMandate Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PUMandatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PUMandatePeer();
        }
    ...
    public function getPUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPUser === null && ($this->p_user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPUser->addPUMandates($this);
             */
        }
    ...
    public function getPQType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPQType === null && ($this->p_q_type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPQType->addPUMandates($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a PQMandate object.
     *
     * @param                  PQMandate $v
     * @return PUMandate The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPQMandate(PQMandate $v = null)
    {
        if ($v === null) {
            $this->setPQMandateId(NULL);
        } else {
            $this->setPQMandateId($v->getId());
        }

        $this->aPQMandate = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the PQMandate object, it will not be re-added.
        if ($v !== null) {
            $v->addPUMandate($this);
        }
    ...
    /**
     * Get the associated PQMandate object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return PQMandate The associated PQMandate object.
     * @throws PropelException
     */
    public function getPQMandate(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPQMandate === null && ($this->p_q_mandate_id !== null) && $doQuery) {
            $this->aPQMandate = PQMandateQuery::create()->findPk($this->p_q_mandate_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPQMandate->addPUMandates($this);
             */
        }

        return $this->aPQMandate;
    }
     ...
     * @throws PropelException
     */
    public function setPQOrganization(PQOrganization $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getPQOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPQOrganization === null && ($this->p_q_organization_id !== null) && $doQuery) {
            $this->aPQOrganization = PQOrganizationQuery::create()->findPk($this->p_q_organization_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPQOrganization->addPUMandates($this);
             */
        }

        return $this->aPQOrganization;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPQMandate instanceof Persistent) {
              $this->aPQMandate->clearAllReferences($deep);
            }
            if ($this->aPQOrganization instanceof Persistent) {
              $this->aPQOrganization->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(PUMandatePeer::DEFAULT_STRING_FORMAT);
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return     PUMandateArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(PropelPDO $con = null)
    {
        ...
        $archive = PUMandateArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     PUMandateArchive The archive object based on this object
     */
     ...
     *
     * @param      PUMandateArchive $archive An archived object based on the same class
    ...
    * Create UUID if is NULL Uuid*/
    ...
    /**
    * If permanent UUID, throw exception p_u_mandate.uuid*/
