...
abstract class BasePOOrderState extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\POOrderStatePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        POOrderStatePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = POOrderStatePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = POOrderStatePeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = POOrderStatePeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = POOrderStatePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = POOrderStatePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = POOrderStatePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating POOrderState object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = POOrderStatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = POOrderStateQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(POOrderStatePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(POOrderStatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(POOrderStatePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                POOrderStatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(POOrderStatePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(POOrderStatePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(POOrderStatePeer::DESCRIPTION)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_o_order_state` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = POOrderStatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = POOrderStatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['POOrderState'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['POOrderState'][$this->getPrimaryKey()] = true;
        $keys = POOrderStatePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(POOrderStatePeer::ID)) $criteria->add(POOrderStatePeer::ID, $this->id);
        if ($this->isColumnModified(POOrderStatePeer::TITLE)) $criteria->add(POOrderStatePeer::TITLE, $this->title);
        if ($this->isColumnModified(POOrderStatePeer::DESCRIPTION)) $criteria->add(POOrderStatePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(POOrderStatePeer::CREATED_AT)) $criteria->add(POOrderStatePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(POOrderStatePeer::UPDATED_AT)) $criteria->add(POOrderStatePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(POOrderStatePeer::DATABASE_NAME);
        $criteria->add(POOrderStatePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of POOrderState (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return POOrderState Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return POOrderStatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new POOrderStatePeer();
        }
     ...
     * If this POOrderState is new, it will return
    ...
    public function setPOrders(PropelCollection $pOrders, PropelPDO $con = null)
    {
        ...
        foreach ($pOrdersToDelete as $pOrderRemoved) {
            $pOrderRemoved->setPOOrderState(null);
        }
     ...
     * Otherwise if this POOrderState is new, it will return
     * an empty collection; or if this POOrderState has previously
     * been saved, it will retrieve related POrders from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in POOrderState.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setPOEmails(PropelCollection $pOEmails, PropelPDO $con = null)
    {
        ...
        foreach ($pOEmailsToDelete as $pOEmailRemoved) {
            $pOEmailRemoved->setPOOrderState(null);
        }
    ...
    {
        return (string) $this->exportTo(POOrderStatePeer::DEFAULT_STRING_FORMAT);
    }
