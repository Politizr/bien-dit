 ...
 *
 * @method PUAffinityQOQuery leftJoinPUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the PUser relation
 * @method PUAffinityQOQuery rightJoinPUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PUser relation
 * @method PUAffinityQOQuery innerJoinPUser($relationAlias = null) Adds a INNER JOIN clause to the query using the PUser relation
 *
 * @method PUAffinityQOQuery leftJoinPQOrganization($relationAlias = null) Adds a LEFT JOIN clause to the query using the PQOrganization relation
 * @method PUAffinityQOQuery rightJoinPQOrganization($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PQOrganization relation
 * @method PUAffinityQOQuery innerJoinPQOrganization($relationAlias = null) Adds a INNER JOIN clause to the query using the PQOrganization relation
 *
