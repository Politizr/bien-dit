...
abstract class BasePUStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUStatusPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUStatusPeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PUStatusPeer::TITLE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUStatusPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUStatusPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating PUStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PUStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUStatusPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PUStatusPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUStatusPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PUStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUStatusPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUStatusPeer::TITLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_status` (%s) VALUES (%s)',
    ...
    {
        $pos = PUStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUStatus'][$this->getPrimaryKey()] = true;
        $keys = PUStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUStatusPeer::ID)) $criteria->add(PUStatusPeer::ID, $this->id);
        if ($this->isColumnModified(PUStatusPeer::TITLE)) $criteria->add(PUStatusPeer::TITLE, $this->title);
        if ($this->isColumnModified(PUStatusPeer::CREATED_AT)) $criteria->add(PUStatusPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PUStatusPeer::UPDATED_AT)) $criteria->add(PUStatusPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PUStatusPeer::DATABASE_NAME);
        $criteria->add(PUStatusPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this PUStatus is new, it will return
     ...
     * @return PropelObjectCollection|PUser[] List of PUser objects
     */
    public function getPUsersJoinPLCity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PUserQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PUStatusPeer::DEFAULT_STRING_FORMAT);
    }
