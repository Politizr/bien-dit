...
abstract class BasePMAskForUpdateArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PMAskForUpdateArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PMAskForUpdateArchivePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PMAskForUpdateArchivePeer::ID;
        }
    ...
    public function setPUserId($v)
    {
        ...
        if ($this->p_user_id !== $v) {
            $this->p_user_id = $v;
            $this->modifiedColumns[] = PMAskForUpdateArchivePeer::P_USER_ID;
        }
    ...
    public function setPObjectName($v)
    {
        ...
        if ($this->p_object_name !== $v) {
            ...
            $this->modifiedColumns[] = PMAskForUpdateArchivePeer::P_OBJECT_NAME;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = PMAskForUpdateArchivePeer::MESSAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMAskForUpdateArchivePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMAskForUpdateArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PMAskForUpdateArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = PMAskForUpdateArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PMAskForUpdateArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PMAskForUpdateArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PMAskForUpdateArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                PMAskForUpdateArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::P_USER_ID)) {
        ...
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `p_m_ask_for_update_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PMAskForUpdateArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PMAskForUpdateArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PMAskForUpdateArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PMAskForUpdateArchive'][$this->getPrimaryKey()] = true;
        $keys = PMAskForUpdateArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PMAskForUpdateArchivePeer::ARCHIVED_AT)) $criteria->add(PMAskForUpdateArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PMAskForUpdateArchivePeer::DATABASE_NAME);
        $criteria->add(PMAskForUpdateArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PMAskForUpdateArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PMAskForUpdateArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PMAskForUpdateArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PMAskForUpdateArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PMAskForUpdateArchivePeer::DEFAULT_STRING_FORMAT);
    }
