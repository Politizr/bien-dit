...
abstract class BasePUMandateArchive extends BaseObject implements Persistent
{
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PUMandateArchivePeer::UUID;
        }
    ...
    public function setLocalization($v)
    {
        ...
        if ($this->localization !== $v) {
            $this->localization = $v;
            $this->modifiedColumns[] = PUMandateArchivePeer::LOCALIZATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = PUMandateArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUMandateArchivePeer::UUID)) {
        ...
        if ($this->isColumnModified(PUMandateArchivePeer::LOCALIZATION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUMandateArchivePeer::UUID)) $criteria->add(PUMandateArchivePeer::UUID, $this->uuid);
        ...
        if ($this->isColumnModified(PUMandateArchivePeer::LOCALIZATION)) $criteria->add(PUMandateArchivePeer::LOCALIZATION, $this->localization);
