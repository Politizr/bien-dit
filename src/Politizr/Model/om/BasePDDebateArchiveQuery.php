...
abstract class BasePDDebateArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `p_user_id`, `file_name`, `title`, `summary`, `description`, `more_info`, `note_pos`, `note_neg`, `published`, `published_at`, `published_by`, `online`, `created_at`, `updated_at`, `archived_at` FROM `p_d_debate_archive` WHERE `id` = :p0';
        try {
