...
use Politizr\Model\map\PUQualificationTableMap;

abstract class BasePUQualificationPeer
{
    ...
    const TABLE_NAME = 'p_u_qualification';

    /** the related Propel class for this table */
    const OM_CLASS = 'Politizr\\Model\\PUQualification';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Politizr\\Model\\map\\PUQualificationTableMap';
    ...
    const END_AT = 'p_u_qualification.end_at';

    /** the column name for the created_at field */
    const CREATED_AT = 'p_u_qualification.created_at';
    ...
    /**
     * An identity map to hold any loaded instances of PUQualification objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array PUQualification[]
     */
    ...
    {
        $toNames = PUQualificationPeer::getFieldNames($toType);
        $key = isset(PUQualificationPeer::$fieldKeys[$fromType][$name]) ? PUQualificationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PUQualificationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PUQualificationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PUQualificationPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PUQualificationPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PUQualificationPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PUQualificationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PUQualificationPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PUQualificationPeer::populateObjects(PUQualificationPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param PUQualification $obj A PUQualification object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PUQualificationPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PUQualification object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PUQualification) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PUQualification object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PUQualificationPeer::$instances[$key]);
        }
     ...
     * @return PUQualification Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PUQualificationPeer::$instances[$key])) {
                return PUQualificationPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (PUQualificationPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        PUQualificationPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to p_u_qualification
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = PUQualificationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = PUQualificationPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                PUQualificationPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (PUQualification object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = PUQualificationPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PUQualificationPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PUQualificationPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PUQualificationPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doSelectJoinPUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PUQualification) to $obj2 (PUser)
    ...
    /**
     * Selects a collection of PUQualification objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(PUQualificationPeer::DATABASE_NAME)->getTable(PUQualificationPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BasePUQualificationPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BasePUQualificationPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Politizr\Model\map\PUQualificationTableMap());
      }
    }
    ...
    {
        return PUQualificationPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PUQualification or Criteria object.
     *
     * @param      mixed $values Criteria or PUQualification object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from PUQualification object
        }

        if ($criteria->containsKey(PUQualificationPeer::ID) && $criteria->keyContainsValue(PUQualificationPeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a PUQualification or Criteria object.
     *
     * @param      mixed $values Criteria or PUQualification object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PUQualificationPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PUQualificationPeer::ID);
            $value = $criteria->remove(PUQualificationPeer::ID);
            if ($value) {
                $selectCriteria->add(PUQualificationPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PUQualificationPeer::TABLE_NAME);
            }

        } else { // $values is PUQualification object
    ...
    /**
     * Deletes all rows from the p_u_qualification table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PUQualificationPeer::TABLE_NAME, $con, PUQualificationPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            PUQualificationPeer::clearInstancePool();
            PUQualificationPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a PUQualification or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or PUQualification object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof PUQualification) { // it's a model object
            // invalidate the cache for this single object
            PUQualificationPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PUQualificationPeer::DATABASE_NAME);
            $criteria->add(PUQualificationPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                PUQualificationPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given PUQualification object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param PUQualification $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            ...
            $tableMap = $dbMap->getTable(PUQualificationPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PUQualificationPeer::DATABASE_NAME, PUQualificationPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PUQualificationPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(PUQualificationPeer::DATABASE_NAME);
        $criteria->add(PUQualificationPeer::ID, $pk);

        $v = PUQualificationPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PUQualificationPeer::DATABASE_NAME);
            $criteria->add(PUQualificationPeer::ID, $pks, Criteria::IN);
            $objs = PUQualificationPeer::doSelect($criteria, $con);
        }

        return $objs;
    }

} // BasePUQualificationPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BasePUQualificationPeer::buildTableMap();
