...
abstract class BasePRBadge extends BaseObject implements Persistent
{
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[] = PRBadgePeer::FILE_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = PRBadgePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PRBadgePeer::FILE_NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PRBadgePeer::FILE_NAME)) $criteria->add(PRBadgePeer::FILE_NAME, $this->file_name);
