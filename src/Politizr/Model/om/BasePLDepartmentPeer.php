...
abstract class BasePLDepartmentPeer
{
    ...
    const TABLE_NAME = 'p_l_department';

    /** the related Propel class for this table */
    const OM_CLASS = 'Politizr\\Model\\PLDepartment';
    ...
    const CREATED_AT = 'p_l_department.created_at';
    ...
    /**
     * An identity map to hold any loaded instances of PLDepartment objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array PLDepartment[]
     */
    ...
    {
        $toNames = PLDepartmentPeer::getFieldNames($toType);
        $key = isset(PLDepartmentPeer::$fieldKeys[$fromType][$name]) ? PLDepartmentPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PLDepartmentPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PLDepartmentPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PLDepartmentPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PLDepartmentPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PLDepartmentPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PLDepartmentPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PLDepartmentPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PLDepartmentPeer::populateObjects(PLDepartmentPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param PLDepartment $obj A PLDepartment object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PLDepartmentPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PLDepartment object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PLDepartment) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PLDepartment object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PLDepartmentPeer::$instances[$key]);
        }
     ...
     * @return PLDepartment Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PLDepartmentPeer::$instances[$key])) {
                return PLDepartmentPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (PLDepartmentPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        PLDepartmentPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to p_l_department
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = PLDepartmentPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = PLDepartmentPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                PLDepartmentPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (PLDepartment object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = PLDepartmentPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PLDepartmentPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PLDepartmentPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PLDepartmentPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doSelectJoinPLRegion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PLDepartment) to $obj2 (PLRegion)
    ...
    /**
     * Selects a collection of PLDepartment objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(PLDepartmentPeer::DATABASE_NAME)->getTable(PLDepartmentPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BasePLDepartmentPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BasePLDepartmentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Politizr\Model\map\PLDepartmentTableMap());
      }
    }
    ...
    {
        return PLDepartmentPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PLDepartment or Criteria object.
     *
     * @param      mixed $values Criteria or PLDepartment object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from PLDepartment object
        }

        if ($criteria->containsKey(PLDepartmentPeer::ID) && $criteria->keyContainsValue(PLDepartmentPeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a PLDepartment or Criteria object.
     *
     * @param      mixed $values Criteria or PLDepartment object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PLDepartmentPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PLDepartmentPeer::ID);
            $value = $criteria->remove(PLDepartmentPeer::ID);
            if ($value) {
                $selectCriteria->add(PLDepartmentPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PLDepartmentPeer::TABLE_NAME);
            }

        } else { // $values is PLDepartment object
    ...
    /**
     * Deletes all rows from the p_l_department table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PLDepartmentPeer::TABLE_NAME, $con, PLDepartmentPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            PLDepartmentPeer::clearInstancePool();
            PLDepartmentPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a PLDepartment or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or PLDepartment object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof PLDepartment) { // it's a model object
            // invalidate the cache for this single object
            PLDepartmentPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PLDepartmentPeer::DATABASE_NAME);
            $criteria->add(PLDepartmentPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                PLDepartmentPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given PLDepartment object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param PLDepartment $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            ...
            $tableMap = $dbMap->getTable(PLDepartmentPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PLDepartmentPeer::DATABASE_NAME, PLDepartmentPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PLDepartmentPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(PLDepartmentPeer::DATABASE_NAME);
        $criteria->add(PLDepartmentPeer::ID, $pk);

        $v = PLDepartmentPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PLDepartmentPeer::DATABASE_NAME);
            $criteria->add(PLDepartmentPeer::ID, $pks, Criteria::IN);
            $objs = PLDepartmentPeer::doSelect($criteria, $con);
        }

        return $objs;
    }

} // BasePLDepartmentPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BasePLDepartmentPeer::buildTableMap();
