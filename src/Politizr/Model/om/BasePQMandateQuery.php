 ...
 * @method PQMandateQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method PQMandateQuery leftJoinPQType($relationAlias = null) Adds a LEFT JOIN clause to the query using the PQType relation
 * @method PQMandateQuery rightJoinPQType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PQType relation
 * @method PQMandateQuery innerJoinPQType($relationAlias = null) Adds a INNER JOIN clause to the query using the PQType relation
 *
 * @method PQMandateQuery leftJoinPUMandate($relationAlias = null) Adds a LEFT JOIN clause to the query using the PUMandate relation
 * @method PQMandateQuery rightJoinPUMandate($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PUMandate relation
 * @method PQMandateQuery innerJoinPUMandate($relationAlias = null) Adds a INNER JOIN clause to the query using the PUMandate relation
 *
...
abstract class BasePQMandateQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of BasePQMandateQuery object.
     *
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Politizr\\Model\\PQMandate';
        }
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new PQMandateQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param   PQMandateQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return PQMandateQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PQMandateQuery) {
            return $criteria;
        }
        $query = new PQMandateQuery(null, null, $modelAlias);
     ...
     *
     * @return   PQMandate|PQMandate[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PQMandatePeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 PQMandate A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new PQMandate();
            $obj->hydrate($row);
            PQMandatePeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PQMandate[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PQMandatePeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PQMandatePeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PQMandatePeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PQMandatePeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByOnline($online = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PQMandatePeer::ONLINE, $online, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PQMandatePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PQMandatePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PQMandatePeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PQMandatePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PQMandatePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PQMandatePeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterBySlug($slug = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PQMandatePeer::SLUG, $slug, $comparison);
    }
    ...
    public function filterBySortableRank($sortableRank = null, $comparison = null)
    {
        if (is_array($sortableRank)) {
            ...
            if (isset($sortableRank['min'])) {
                $this->addUsingAlias(PQMandatePeer::SORTABLE_RANK, $sortableRank['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($sortableRank['max'])) {
                $this->addUsingAlias(PQMandatePeer::SORTABLE_RANK, $sortableRank['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PQMandatePeer::SORTABLE_RANK, $sortableRank, $comparison);
    }
    ...
    public function filterByPQType($pQType, $comparison = null)
    {
        if ($pQType instanceof PQType) {
            return $this
                ->addUsingAlias(PQMandatePeer::P_Q_TYPE_ID, $pQType->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PQMandatePeer::P_Q_TYPE_ID, $pQType->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByPUMandate($pUMandate, $comparison = null)
    {
        if ($pUMandate instanceof PUMandate) {
            return $this
                ->addUsingAlias(PQMandatePeer::ID, $pUMandate->getPQMandateId(), $comparison);
     ...
     *
     * @param   PQMandate $pQMandate Object to remove from the list of results
     *
     * @return PQMandateQuery The current query, for fluid interface
     */
    public function prune($pQMandate = null)
    {
        if ($pQMandate) {
            $this->addUsingAlias(PQMandatePeer::ID, $pQMandate->getId(), Criteria::NOT_EQUAL);
        }
    ...
    {
        return $this->addUsingAlias(PQMandatePeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PQMandatePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PQMandatePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PQMandatePeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PQMandatePeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PQMandatePeer::CREATED_AT);
    }
    // query_cache behavior
    ...
    protected function doSelect($con)
    {
        ...
        $db = Propel::getDB(PQMandatePeer::DATABASE_NAME);
    ...
    public function filterByRank($rank, $scope = null)
    {
        ...
        return $this
            ->inList($scope)
            ->addUsingAlias(PQMandatePeer::RANK_COL, $rank, Criteria::EQUAL);
    }
    ...
    public function orderByRank($order = Criteria::ASC)
    {
        ...
        switch ($order) {
            case Criteria::ASC:
                return $this->addAscendingOrderByColumn($this->getAliasedColName(PQMandatePeer::RANK_COL));
                break;
            case Criteria::DESC:
                return $this->addDescendingOrderByColumn($this->getAliasedColName(PQMandatePeer::RANK_COL));
                break;
            default:
                throw new PropelException('PQMandateQuery::orderBy() only accepts "asc" or "desc" as argument');
        }
    }
    ...
    public function getMaxRank($scope = null, PropelPDO $con = null)
    {
        ...
        $this->addSelectColumn('MAX(' . PQMandatePeer::RANK_COL . ')');

        PQMandatePeer::sortableApplyScopeCriteria($this, $scope);
