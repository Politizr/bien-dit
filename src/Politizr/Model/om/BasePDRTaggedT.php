...
abstract class BasePDRTaggedT extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PDRTaggedTPeer';
     ...
     * @return PDRTaggedT The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PDRTaggedTPeer::ID;
        }
    ...
    public function setPDReactionId($v)
    {
        ...
        if ($this->p_d_reaction_id !== $v) {
            ...
            $this->modifiedColumns[] = PDRTaggedTPeer::P_D_REACTION_ID;
        }
    ...
    public function setPTagId($v)
    {
        ...
        if ($this->p_tag_id !== $v) {
            $this->p_tag_id = $v;
            $this->modifiedColumns[] = PDRTaggedTPeer::P_TAG_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDRTaggedTPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PDRTaggedTPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PDRTaggedTPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PDRTaggedT object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PDRTaggedTPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PDRTaggedTQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // archivable behavior
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling PDRTaggedTQuery::delete().
                } else {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PDRTaggedTPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PDRTaggedTPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PDRTaggedTPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                PDRTaggedTPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PDRTaggedTPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PDRTaggedTPeer::P_D_REACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`p_d_reaction_id`';
        }
        if ($this->isColumnModified(PDRTaggedTPeer::P_TAG_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_d_r_tagged_t` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PDRTaggedTPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PDRTaggedTPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PDRTaggedT'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PDRTaggedT'][$this->getPrimaryKey()] = true;
        $keys = PDRTaggedTPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PDRTaggedTPeer::ID)) $criteria->add(PDRTaggedTPeer::ID, $this->id);
        if ($this->isColumnModified(PDRTaggedTPeer::P_D_REACTION_ID)) $criteria->add(PDRTaggedTPeer::P_D_REACTION_ID, $this->p_d_reaction_id);
        if ($this->isColumnModified(PDRTaggedTPeer::P_TAG_ID)) $criteria->add(PDRTaggedTPeer::P_TAG_ID, $this->p_tag_id);
        if ($this->isColumnModified(PDRTaggedTPeer::CREATED_AT)) $criteria->add(PDRTaggedTPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PDRTaggedTPeer::UPDATED_AT)) $criteria->add(PDRTaggedTPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PDRTaggedTPeer::DATABASE_NAME);
        $criteria->add(PDRTaggedTPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PDRTaggedT (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PDRTaggedT Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PDRTaggedTPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PDRTaggedTPeer();
        }
    ...
    public function getPDReaction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPDReaction === null && ($this->p_d_reaction_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPDReaction->addPDRTaggedTs($this);
             */
        }
    ...
    public function getPTag(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPTag === null && ($this->p_tag_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPTag->addPDRTaggedTs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PDRTaggedTPeer::DEFAULT_STRING_FORMAT);
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return     PDRTaggedTArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(PropelPDO $con = null)
    {
        ...
        $archive = PDRTaggedTArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     PDRTaggedTArchive The archive object based on this object
     */
     ...
     *
     * @param      PDRTaggedTArchive $archive An archived object based on the same class
    ...
    public function populateFromArchive($archive, $populateAutoIncrementPrimaryKeys = false) {
        ...
        $this->setPTagId($archive->getPTagId());
