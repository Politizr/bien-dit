 ...
 * @method PDRCommentQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method PDRCommentQuery groupByUuid() Group by the uuid column
 ...
 *
 * @method PDRComment findOneByUuid(string $uuid) Return the first PDRComment filtered by the uuid column
 ...
 * @method array findByUuid(string $uuid) Return PDRComment objects filtered by the uuid column
...
abstract class BasePDRCommentQuery extends ModelCriteria
{
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new PDRCommentQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT `id`, `uuid`, `p_user_id`, `p_d_reaction_id`, `description`, `paragraph_no`, `note_pos`, `note_neg`, `published_at`, `published_by`, `online`, `moderated`, `moderated_partial`, `moderated_at`, `created_at`, `updated_at` FROM `p_d_r_comment` WHERE `id` = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PDRCommentPeer::UUID, $uuid, $comparison);
    }
