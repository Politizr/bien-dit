...
abstract class BasePLRegion extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PLRegionPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PLRegionPeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PLRegionPeer::UUID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PLRegionPeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PLRegionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PLRegionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PLRegionPeer::CREATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PLRegionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PLRegionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `p_l_region` (%s) VALUES (%s)',
    ...
    {
        $pos = PLRegionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PLRegion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PLRegion'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(PLRegionPeer::DATABASE_NAME);
        $criteria->add(PLRegionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PLRegion (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PLRegion Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPLDepartments(PropelCollection $pLDepartments, PropelPDO $con = null)
    {
        ...
        foreach ($pLDepartmentsToDelete as $pLDepartmentRemoved) {
            $pLDepartmentRemoved->setPLRegion(null);
        }
    ...
    {
        return (string) $this->exportTo(PLRegionPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    * Create UUID if is NULL Uuid*/
    ...
    /**
    * If permanent UUID, throw exception p_l_region.uuid*/
