...
abstract class BasePCOwnerArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PCOwnerArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PCOwnerArchivePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::ID;
        }
    ...
    public function setUuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::UUID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::TITLE;
        }
    ...
    public function setSummary($v)
    {
        ...
        if ($this->summary !== $v) {
            $this->summary = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::SUMMARY;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCOwnerArchivePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCOwnerArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PCOwnerArchivePeer::SLUG;
        }
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PCOwnerArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PCOwnerArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PCOwnerArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PCOwnerArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PCOwnerArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::SUMMARY)) {
            $modifiedColumns[':p' . $index++]  = '`summary`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PCOwnerArchivePeer::UPDATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_c_owner_archive` (%s) VALUES (%s)',
    ...
    {
        $pos = PCOwnerArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PCOwnerArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PCOwnerArchive'][$this->getPrimaryKey()] = true;
        $keys = PCOwnerArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUuid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PCOwnerArchivePeer::ID)) $criteria->add(PCOwnerArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PCOwnerArchivePeer::UUID)) $criteria->add(PCOwnerArchivePeer::UUID, $this->uuid);
        if ($this->isColumnModified(PCOwnerArchivePeer::TITLE)) $criteria->add(PCOwnerArchivePeer::TITLE, $this->title);
        if ($this->isColumnModified(PCOwnerArchivePeer::SUMMARY)) $criteria->add(PCOwnerArchivePeer::SUMMARY, $this->summary);
        if ($this->isColumnModified(PCOwnerArchivePeer::DESCRIPTION)) $criteria->add(PCOwnerArchivePeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(PCOwnerArchivePeer::DATABASE_NAME);
        $criteria->add(PCOwnerArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PCOwnerArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PCOwnerArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PCOwnerArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PCOwnerArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PCOwnerArchivePeer::DEFAULT_STRING_FORMAT);
    }
