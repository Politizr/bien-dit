...
abstract class BasePUType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Politizr\\Model\\PUTypePeer';
     ...
     * @return PUType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PUTypePeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PUTypePeer::TITLE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PUTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PUTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PUType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PUTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PUTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PUTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PUTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PUTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PUTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->pUsersScheduledForDeletion !== null) {
                if (!$this->pUsersScheduledForDeletion->isEmpty()) {
                    PUserQuery::create()
                        ->filterByPrimaryKeys($this->pUsersScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PUTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PUTypePeer::TITLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `p_u_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PUTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PUTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PUType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PUType'][$this->getPrimaryKey()] = true;
        $keys = PUTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PUTypePeer::ID)) $criteria->add(PUTypePeer::ID, $this->id);
        if ($this->isColumnModified(PUTypePeer::TITLE)) $criteria->add(PUTypePeer::TITLE, $this->title);
        if ($this->isColumnModified(PUTypePeer::CREATED_AT)) $criteria->add(PUTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PUTypePeer::UPDATED_AT)) $criteria->add(PUTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PUTypePeer::DATABASE_NAME);
        $criteria->add(PUTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PUType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PUType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this PUType is new, it will return
    ...
    public function removePUser($pUser)
    {
        if ($this->getPUsers()->contains($pUser)) {
            ...
            $this->pUsersScheduledForDeletion[]= clone $pUser;
            $pUser->setPUType(null);
        }
     ...
     * Otherwise if this PUType is new, it will return
     * an empty collection; or if this PUType has previously
     * been saved, it will retrieve related PUsers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PUType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(PUTypePeer::DEFAULT_STRING_FORMAT);
    }
