 ...
 * up to version 1495554682.
 * Generated on 2017-05-23 17:51:22 by lionel
 */
class PropelMigration_1495554682
{
...
CREATE INDEX `p_d_debate_FI_6` ON `p_d_debate` (`p_e_operation_id`);
...
CREATE INDEX `p_d_debate_archive_I_6` ON `p_d_debate_archive` (`p_e_operation_id`);
