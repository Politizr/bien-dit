 ...
 * up to version 1503912784.
 * Generated on 2017-08-28 11:33:04 by lionel
 */
class PropelMigration_1503912784
{
...
ALTER TABLE `p_r_badge`
    ADD `file_name` VARCHAR(150) AFTER `title`;
...
ALTER TABLE `p_r_badge` DROP `file_name`;

ALTER TABLE `p_r_badge_archive` DROP `file_name`;
